...
public class ContractAttachmentController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = ContractAttachmentVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractAttachmentVOMeta.OWNER_ID , value = "所有者ID" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractAttachmentVOMeta.OWNER_TYPE , value = "所有者类型" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractAttachmentVOMeta.TYPE , value = "附件类型" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractAttachmentVOMeta.FILE_ID , value = "文件ID" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractAttachmentVOMeta.NAME , value = "附件名称" , required = false , dataTypeClass=String.class),
