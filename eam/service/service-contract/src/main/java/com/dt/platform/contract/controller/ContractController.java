...
public class ContractController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = ContractVOMeta.FIRST_UNIT , value = "我方单位" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.FIRST_CONTACTS , value = "我方联系人" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.FIRST_CONTACT , value = "我方联系方式" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.RELATED_UNIT_ID , value = "对方单位" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.RELATED_UNIT , value = "对方单位" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.RELATED_CONTACTS , value = "对方单位用户" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContractVOMeta.RELATED_CONTACT , value = "对方单位联系人" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = ContractVOMeta.SUPERVISION_CONTACT , value = "监理联系方式" , required = false , dataTypeClass=String.class),
