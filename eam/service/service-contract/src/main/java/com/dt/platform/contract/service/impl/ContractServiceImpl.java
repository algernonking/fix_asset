...
public class ContractServiceImpl extends SuperService<Contract> implements IContractService {
	...
	public Result insert(Contract contract) {
		Result r=super.insert(contract);
		return r;
	}
	...
	public Result update(Contract contract , SaveMode mode) {
		Result r=super.update(contract , mode);
		return r;
	}
	 ...
	 * @return 判断结果
	 */
	public Result<Contract> checkExists(Contract contract) {
		//TDOD 此处添加判断段的代码
		//boolean exists=this.checkExists(contract, SYS_ROLE.NAME);
		//return exists;
