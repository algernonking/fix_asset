...
public interface IEmployeeService extends ISuperService<Employee> {
	 ...
	 * @return 插入是否成功
	 * */
	boolean insertList(List<Employee> employeeList);
	 ...
	 * @return 保存是否成功
	 * */
	boolean update(Employee employee , SaveMode mode);
	 ...
	 * @return 保存是否成功
	 * */
	boolean updateList(List<Employee> employeeList, SaveMode mode);
	 ...
	 * @return 保存是否成功
	 * */
	boolean save(Employee employee , SaveMode mode);
	 ...
	 * @return 保存是否成功
	 * */
	boolean saveList(List<Employee> employeeList , SaveMode mode);
	 ...
	 * */
	ConditionExpr buildQueryCondition(Employee sample,boolean stringFuzzy);
	 ...
	 * @return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(Employee sample,boolean stringFuzzy,String tableAliase);
