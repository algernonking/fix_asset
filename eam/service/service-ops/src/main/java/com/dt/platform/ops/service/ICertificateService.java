...
public interface ICertificateService extends ISuperService<Certificate> {
	 ...
	 * @return 查询结果
	 * */
	List<Certificate> queryList(Certificate sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<Certificate> queryPagedList(Certificate sample,int pageSize,int pageIndex);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(Certificate sample);
