package com.dt.eam.ops.controller;
...
import com.dt.eam.proxy.ops.HostServiceProxy;
import com.dt.eam.domain.ops.meta.HostVOMeta;
import com.dt.eam.domain.ops.Host;
import com.dt.eam.domain.ops.HostVO;
...
import com.dt.eam.ops.service.IHostService;
...
public class HostController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = HostVOMeta.HOST_CONF_CPU , value = "CPU" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = HostVOMeta.HOST_CONF_MEMORY , value = "memory" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = HostVOMeta.VIP , value = "虚拟IP" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = HostVOMeta.ENVIRONMENT , value = "运行环境:prod" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = HostVOMeta.STATUS , value = "online" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = HostVOMeta.PASSWORD_STRATEGY , value = "改密策略" , required = false , dataTypeClass=String.class),
	...
	*/
	...
	@ApiOperationSupport( order=4 , ignoreParameters = { HostVOMeta.PAGE_INDEX , HostVOMeta.PAGE_SIZE , HostVOMeta.SEARCH_FIELD , HostVOMeta.SEARCH_VALUE , HostVOMeta.SORT_FIELD , HostVOMeta.SORT_TYPE , HostVOMeta.IDS } ) 
	@NotNull(name = HostVOMeta.ID)
	@NotNull(name = HostVOMeta.HOST_IP)
	...
	*/
	...
	@ApiOperationSupport(order=5 ,  ignoreParameters = { HostVOMeta.PAGE_INDEX , HostVOMeta.PAGE_SIZE , HostVOMeta.SEARCH_FIELD , HostVOMeta.SEARCH_VALUE , HostVOMeta.SORT_FIELD , HostVOMeta.SORT_TYPE , HostVOMeta.IDS } )
	@NotNull(name = HostVOMeta.ID)
	@NotNull(name = HostVOMeta.HOST_IP)
	...
	*/
	...
	public Result<Host> getById(String id) {
		...
		Host role=hostService.getById(id);
