package com.dt.eam.ops.service;
...
public interface IHostService extends ISuperService<Host> {
	 ...
	 * */
	ConditionExpr buildQueryCondition(Host sample,boolean stringFuzzy);
	 ...
	 * @return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(Host sample,boolean stringFuzzy,String tableAliase);
