...
public class MonitorNodeValueController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.MONITOR_TPL_CODE , value = "监控模版" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.INDICATOR_CODE , value = "指标" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.VALUE_INT1 , value = "整数1" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.VALUE_INT2 , value = "整数2" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.VALUE_INT3 , value = "整数3" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = MonitorNodeValueVOMeta.LIST_CODE23 , value = "编码列3" , required = false , dataTypeClass=String.class),
