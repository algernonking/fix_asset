...
public interface IMonitorTplService extends ISuperService<MonitorTpl> {
	 ...
	 * @return 实体集
	 * */
	List<MonitorTpl> getByIds(List<String> ids);
	 ...
	 * @return 查询结果
	 * */
	List<MonitorTpl> queryList(MonitorTpl sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<MonitorTpl> queryPagedList(MonitorTpl sample,int pageSize,int pageIndex);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(MonitorTpl sample);
