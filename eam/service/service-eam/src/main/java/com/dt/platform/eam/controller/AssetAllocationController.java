...
public class AssetAllocationController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = AssetAllocationVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = AssetAllocationVOMeta.OUT_MANAGEMENT_ORGANIZATION_ID , value = "调出所属组织" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetAllocationVOMeta.IN_MANAGEMENT_ORGANIZATION_ID , value = "调入所属组织" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetAllocationVOMeta.MANAGER_ID , value = "调入管理员" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetAllocationVOMeta.CONTENT , value = "调拨说明" , required = false , dataTypeClass=String.class),
