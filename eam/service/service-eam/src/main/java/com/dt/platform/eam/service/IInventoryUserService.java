...
public interface IInventoryUserService extends ISuperService<InventoryUser> {
	 ...
	 * @return 实体集
	 * */
	List<InventoryUser> getByIds(List<String> ids);
	 ...
	 * 	@return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(InventoryUser sample,String tableAliase);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(InventoryUser sample);
