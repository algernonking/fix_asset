...
public class ManufacturerServiceImpl extends SuperService<Manufacturer> implements IManufacturerService {
	 ...
	 * */
	@Override
	public boolean insertList(List<Manufacturer> manufacturerList) {
	...
	public boolean deleteByIdPhysical(String id) {
		...
		return dao.deleteEntity(manufacturer);
	}
	...
	public boolean deleteByIdLogical(String id) {
		...
		return dao.updateEntity(manufacturer,SaveMode.NOT_NULL_FIELDS);
	}
	 ...
	 * */
	@Override
	public boolean update(Manufacturer manufacturer , SaveMode mode) {
	 ...
	 * */
	@Override
	public boolean updateList(List<Manufacturer> manufacturerList , SaveMode mode) {
	 ...
	 * @return 判断结果
	 */
	public Result<Manufacturer> checkExists(Manufacturer role) {
		//TDOD 此处添加判断段的代码
