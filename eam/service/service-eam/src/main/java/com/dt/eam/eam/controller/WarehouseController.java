...
import com.dt.eam.domain.eam.meta.WarehouseVOMeta;
import com.dt.eam.domain.eam.Warehouse;
...
import com.dt.eam.eam.service.IWarehouseService;
...
public class WarehouseController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = WarehouseVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = WarehouseVOMeta.WAREHOUSE_NAME , value = "名称" , required = true , dataTypeClass=String.class),
	...
	*/
	...
	@ApiOperationSupport( order=4 , ignoreParameters = { WarehouseVOMeta.PAGE_INDEX , WarehouseVOMeta.PAGE_SIZE , WarehouseVOMeta.SEARCH_FIELD , WarehouseVOMeta.SEARCH_VALUE , WarehouseVOMeta.SORT_FIELD , WarehouseVOMeta.SORT_TYPE , WarehouseVOMeta.IDS } ) 
	@NotNull(name = WarehouseVOMeta.ID)
	@NotNull(name = WarehouseVOMeta.WAREHOUSE_NAME)
	...
	*/
	...
	@ApiOperationSupport(order=5 ,  ignoreParameters = { WarehouseVOMeta.PAGE_INDEX , WarehouseVOMeta.PAGE_SIZE , WarehouseVOMeta.SEARCH_FIELD , WarehouseVOMeta.SEARCH_VALUE , WarehouseVOMeta.SORT_FIELD , WarehouseVOMeta.SORT_TYPE , WarehouseVOMeta.IDS } )
	@NotNull(name = WarehouseVOMeta.ID)
	@NotNull(name = WarehouseVOMeta.WAREHOUSE_NAME)
