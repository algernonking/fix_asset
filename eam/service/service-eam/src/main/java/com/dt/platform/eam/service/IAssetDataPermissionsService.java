...
public interface IAssetDataPermissionsService extends ISuperService<AssetDataPermissions> {
	 ...
	 * @return 实体集
	 * */
	List<AssetDataPermissions> getByIds(List<String> ids);
	 ...
	 * @return 查询结果
	 * */
	List<AssetDataPermissions> queryList(AssetDataPermissions sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<AssetDataPermissions> queryPagedList(AssetDataPermissions sample,int pageSize,int pageIndex);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(AssetDataPermissions sample);
