...
public class AssetLabelTplItemController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = AssetLabelTplItemVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetLabelTplItemVOMeta.TPL_ID , value = "模版" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetLabelTplItemVOMeta.COL_ID , value = "字段ID" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetLabelTplItemVOMeta.SORT , value = "顺序" , required = false , dataTypeClass=Integer.class),
	})
