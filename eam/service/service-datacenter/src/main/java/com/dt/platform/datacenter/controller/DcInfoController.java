...
public class DcInfoController extends SuperController {
	...
	*/
	...
	@ApiOperationSupport( order=4 , ignoreParameters = { DcInfoVOMeta.PAGE_INDEX , DcInfoVOMeta.PAGE_SIZE , DcInfoVOMeta.SEARCH_FIELD , DcInfoVOMeta.FUZZY_FIELD , DcInfoVOMeta.SEARCH_VALUE , DcInfoVOMeta.SORT_FIELD , DcInfoVOMeta.SORT_TYPE , DcInfoVOMeta.IDS } ) 
	@NotNull(name = DcInfoVOMeta.ID)
	...
	*/
	...
	@ApiOperationSupport(order=5 ,  ignoreParameters = { DcInfoVOMeta.PAGE_INDEX , DcInfoVOMeta.PAGE_SIZE , DcInfoVOMeta.SEARCH_FIELD , DcInfoVOMeta.FUZZY_FIELD , DcInfoVOMeta.SEARCH_VALUE , DcInfoVOMeta.SORT_FIELD , DcInfoVOMeta.SORT_TYPE , DcInfoVOMeta.IDS } )
	@NotNull(name = DcInfoVOMeta.ID)
