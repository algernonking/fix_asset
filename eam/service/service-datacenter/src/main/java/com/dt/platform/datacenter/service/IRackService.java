...
public interface IRackService extends ISuperService<Rack> {
	 ...
	 */
	Result insert(Rack rack,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(Rack rack , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(Rack rack , SaveMode mode,boolean throwsException);
