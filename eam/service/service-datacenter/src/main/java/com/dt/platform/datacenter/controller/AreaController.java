...
public class AreaController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AreaVOMeta.TYPE_ID , value = "类型" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = AreaVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class),
	...
	@NotNull(name = AreaVOMeta.TYPE_ID)
