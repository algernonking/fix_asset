...
public class ContentController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = ContentVOMeta.ONTENT_TYPE , value = "内容类型" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContentVOMeta.REVIEW_COUNT , value = "review_count" , required = false , dataTypeClass=BigDecimal.class),
		@ApiImplicitParam(name = ContentVOMeta.ATTACH , value = "附件" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = ContentVOMeta.DISPLAY , value = "显示" , required = false , dataTypeClass=Integer.class),
		@ApiImplicitParam(name = ContentVOMeta.SHARE_URL , value = "分享" , required = false , dataTypeClass=String.class),
