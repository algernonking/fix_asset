...
public class CodeAllocationController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = CodeAllocationVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = CodeAllocationVOMeta.MODULE , value = "所属模块" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CodeAllocationVOMeta.RULE_ID , value = "所属模块" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CodeAllocationVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class),
	})
