...
@Controller("GoodsStockRealAllPageController")
@RequestMapping(GoodsStockRealAllPageController.prefix)
public class GoodsStockRealAllPageController extends ViewController {
	
	public static final String prefix="business/eam/goods_stock_real_all";
