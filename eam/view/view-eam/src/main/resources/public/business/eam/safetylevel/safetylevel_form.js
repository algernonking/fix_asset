...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-safetylevel-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('eam-safetylevel-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-safetylevel-form-data-popup-index');
