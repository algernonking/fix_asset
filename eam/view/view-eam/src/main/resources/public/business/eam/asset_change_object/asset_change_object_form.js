...
function FormPage() {
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			admin.putTempData('eam-asset-change-object-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-asset-change-object-form-data');
	    ...
	    form.on('submit(submit-button)', function (data) {
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('eam-asset-change-object-form-data-popup-index');
