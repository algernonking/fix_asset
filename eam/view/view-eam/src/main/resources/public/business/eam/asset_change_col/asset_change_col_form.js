...
function FormPage() {
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			admin.putTempData('eam-asset-change-col-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-asset-change-col-form-data');
	    ...
	    form.on('submit(submit-button)', function (data) {
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('eam-asset-change-col-form-data-popup-index');
