...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-asset-ext-equipment-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			admin.putTempData('eam-asset-ext-equipment-form-area', area);
    ...
    function bindButtonEvent() {
	    ...
	    form.on('submit(submit-button)', function (data) {
			...
			//获取 机柜 下拉框的值
			data.field["rackId"]=fox.getSelectedValue("rackId",false);
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('eam-asset-ext-equipment-form-data-popup-index');
