		...
		table.on('tool(data-table)', function (obj) {
			...
			if (layEvent === 'edit') { // 修改
				admin.post(moduleURL+"/get-by-id", { id : data.id }, function (data) {
					if(data.success) {
						admin.putTempData('eam-purchase-apply-form-data-form-action', "edit",true);
				...
				top.layer.confirm(fox.translate('确定删除此')+fox.translate('采购申请')+fox.translate('吗？'), function (i) {
					top.layer.close(i);
