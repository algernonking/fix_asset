...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-asset-allocation-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-asset-allocation-form-data');
	    ...
	    form.on('submit(submit-button)', function (data) {
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('eam-asset-allocation-form-data-popup-index');
