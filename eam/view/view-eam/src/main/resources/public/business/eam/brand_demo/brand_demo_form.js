...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('eam-brand-demo-form-data-form-action');
		//如果没有修改和保存权限
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('eam-brand-demo-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('eam-brand-demo-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-brand-demo-form-data-popup-index');
