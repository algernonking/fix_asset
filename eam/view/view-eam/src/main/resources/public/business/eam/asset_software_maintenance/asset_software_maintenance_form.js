...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('eam-asset-software-maintenance-form-data-form-action');
		//如果没有修改和保存权限
		...
		if(window.pageExt.form.beforeInit) {
			window.pageExt.form.beforeInit(action,admin.getTempData('eam-asset-software-maintenance-form-data'));
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			var area=admin.changePopupArea(null,bodyHeight+footerHeight,'eam-asset-software-maintenance-form-data-win');
			if(area==null) return;
			admin.putTempData('eam-asset-software-maintenance-form-area', area);
	...
	function renderFormFields() {
		...
		laydate.render({
			...
			format:"yyyy-MM-dd",
			value:$('#maintenanceStartDate').val()?$('#maintenanceStartDate').val():new Date(),
			trigger:"click",
		...
		laydate.render({
			...
			format:"yyyy-MM-dd",
			value:$('#maintenanceEndDate').val()?$('#maintenanceEndDate').val():new Date(),
			trigger:"click",
			done: function(value, date, endDate){
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('eam-asset-software-maintenance-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.post(api, param, function (data) {
			if (data.success) {
				...
				if(doNext) {
					admin.finishPopupCenterById('eam-asset-software-maintenance-form-data-win');
				}
			} else {
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('eam-asset-software-maintenance-form-data-win'); });
