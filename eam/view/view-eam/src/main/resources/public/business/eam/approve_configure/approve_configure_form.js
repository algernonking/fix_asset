...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-approve-configure-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('eam-approve-configure-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-approve-configure-form-data');
	...
	function getFormData() {
		...
		//获取 审批类型 下拉框的值
		data["approvalType"]=fox.getSelectedValue("approvalType",false);
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-approve-configure-form-data-popup-index');
