...
function ListPage() {
	...
	function refreshTableData(sortField,sortType) {
		var value = {};
		value.manufacturerName={ value: $("#manufacturerName").val() ,fuzzy: true,valuePrefix:"",valueSuffix:" "};
		value.manufacturerNotes={ value: $("#manufacturerNotes").val() ,fuzzy: true,valuePrefix:"",valueSuffix:" "};
