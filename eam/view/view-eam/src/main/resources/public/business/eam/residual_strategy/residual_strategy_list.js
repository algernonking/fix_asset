		...
		function renderTableInternal() {
			...
			fox.renderTable({
				...
				cols: [[
					...
					,{ field: 'strategyDescribe', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('策略描述') }
					,{ field: 'residualvalueRate', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('残值率') }
					,{ field: 'depreciationRate', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('折旧率') }
					,{ field: 'value', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('设置值') }
