...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-manufacturer-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-manufacturer-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-manufacturer-form-data-popup-index');
