...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-asset-borrow-data-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			admin.putTempData('eam-asset-borrow-data-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-asset-borrow-data-form-data');
		//如果是新建
		if(!formData.id) {
			adjustPopup();
		}
	    ...
	    form.on('submit(submit-button)', function (data) {
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('eam-asset-borrow-data-form-data-popup-index');
