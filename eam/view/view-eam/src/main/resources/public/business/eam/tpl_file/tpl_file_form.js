...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-tpl-file-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('eam-tpl-file-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-tpl-file-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-tpl-file-form-data-popup-index');
