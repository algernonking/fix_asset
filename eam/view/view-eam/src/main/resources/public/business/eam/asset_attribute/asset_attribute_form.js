...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-asset-attribute-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('eam-asset-attribute-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('eam-asset-attribute-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-asset-attribute-form-data-popup-index');
