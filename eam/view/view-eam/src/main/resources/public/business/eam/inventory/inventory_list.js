...
function ListPage() {
		...
		function renderTableInternal() {
			...
			dataTable=fox.renderTable({
				...
				cols: [[
					...
					,{ field: 'businessCode', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('业务编码') }
					,{ field: 'name', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('盘点名称') }
					,{ field: 'status', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('状态') }
					,{ field: 'dataStatus', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('数据状态') }
					,{ field: 'categoryId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('资产分类') }
					...
					,{ field: 'positionId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('资产位置') }
					,{ field: 'directoryId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('负责人') }
					,{ field: 'startTime', align:"right", fixed:false, hide:false, sort: true, title: fox.translate('开始时间'), templet: function (d) { return fox.dateFormat(d.startTime); }}
					,{ field: 'finishTime', align:"right", fixed:false, hide:false, sort: true, title: fox.translate('结束时间'), templet: function (d) { return fox.dateFormat(d.finishTime); }}
	...
	function bindButtonEvent() {
        ...
        function batchDelete(selected) {
            ...
            if(ids.length==0) {
            	layer.msg(fox.translate('请选择需要删除的')+fox.translate('资产盘点')+"!");
            	return;
            }
            //调用批量删除接口
			layer.confirm(fox.translate('确定删除已选中的')+fox.translate('资产盘点')+fox.translate('吗？'), function (i) {
				layer.close(i);
    ...
    function bindRowOperationEvent() {
		...
		table.on('tool(data-table)', function (obj) {
			...
			if (layEvent === 'edit') { // 修改
				...
				layer.confirm(fox.translate('确定删除此')+fox.translate('资产盘点')+fox.translate('吗？'), function (i) {
					layer.close(i);
	...
	function showEditForm(data) {
		...
		var title = (data && data.id) ? (fox.translate('修改')+fox.translate('资产盘点')) : (fox.translate('添加')+fox.translate('资产盘点'));
		...
		admin.putTempData('eam-inventory-form-data-popup-index', index);
	};
