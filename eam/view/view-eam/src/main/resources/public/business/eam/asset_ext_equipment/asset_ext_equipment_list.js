		...
		function renderTableInternal() {
			...
			fox.renderTable({
				...
				cols: [[
					...
					,{ field: 'areaId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('区域') }
					,{ field: 'layerId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('层级') }
					,{ field: 'rackId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('机柜') }
