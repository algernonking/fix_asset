...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-eam/dc-info";
	...
	function refreshTableData(sortField,sortType) {
		...
		value.dcName={ value: $("#dcName").val() };
		value.dcPosition={ value: $("#dcPosition").val() };
		value.dcNotes={ value: $("#dcNotes").val() };
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			type: 2,
			content: '/business/eam/nfo/nfo_form.html' + queryString,
			finish: function () {
				refreshTableData();
			}
		});
