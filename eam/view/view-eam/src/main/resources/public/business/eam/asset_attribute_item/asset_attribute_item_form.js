...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('eam-asset-attribute-item-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('eam-asset-attribute-item-form-data-popup-index');
