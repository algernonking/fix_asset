		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'stockName', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('库存名称') , templet: function (d) { return templet('stockName',d.stockName,d);}  }
