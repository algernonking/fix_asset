    ...
    function (exports) {
        function getColumnList(templet) {
            var COL_ALL_DATA={
                ...
                ,tax_amount_price:{ field: 'taxAmountPrice', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('含税金额') , templet: function (d) { return templet('taxAmountPrice',d.taxAmountPrice,d);}  }
                ,total_amount_price:{ field: 'totalAmountPrice', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('资产总值') , templet: function (d) { return templet('totalAmountPrice',d.totalAmountPrice,d);}  }
