...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('dc-area-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData() {
		var formData = admin.getTempData('dc-area-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('dc-area-form-data-popup-index');
