...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('ops-service-group-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData() {
		var formData = admin.getTempData('ops-service-group-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('ops-service-group-form-data-popup-index');
