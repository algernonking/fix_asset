...
function FormPage() {
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			admin.putTempData('ops-host-db-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('ops-host-db-form-data');
		//如果是新建
		if(!formData.id) {
			adjustPopup();
		}
	    ...
	    form.on('submit(submit-button)', function (data) {
	        ...
	        admin.request(api, data.field, function (data) {
	            ...
	            if (data.success) {
					...
					var index=admin.getTempData('ops-host-db-form-data-popup-index');
