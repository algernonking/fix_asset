...
function FormPage() {
	...
	function fillFormData() {
		var formData = admin.getTempData('ops-voucher-owner-form-data');
		...
		if (formData) {
			...
			//设置  类别 设置下拉框勾选
			fox.setSelectValue4Dict("#categoryCode",formData.categoryCode,SELECT_CATEGORYCODE_DATA);
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('ops-voucher-owner-form-data-popup-index');
