        ...
        function renderTableInternal() {
            ...
            var tableConfig={
                ...
                cols: [[
                    ...
                    ,
                    { field: 'id', align:"left",fixed:false,  hide:true, sort: true, title: fox.translate('组织ID') , templet: function (d) { return templet('id',d.id,d);}  }
                    ...
                    ,{ field: 'dataMemoryUsed', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('物理内存使用率') , templet: function (d) { return templet('dataMemoryUsed',d.dataMemoryUsed,d);}  }
                    ,{ field: 'dataMemoryUsed', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('物理内存使用率') , templet: function (d) { return templet('dataMemoryUsed',d.dataMemoryUsed,d);}  }
                    ,{ field: 'osNetInterfaceFlowDown', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('下行流量') , templet: function (d) { return templet('osNetInterfaceFlowDown',d.osNetInterfaceFlowDown,d);}  }
                    ,{ field: 'osNetInterfaceFlowUp', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('上行流量') , templet: function (d) { return templet('osNetInterfaceFlowUp',d.osNetInterfaceFlowUp,d);}  }
