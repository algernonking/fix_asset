...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('workorder-category-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('workorder-category-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('workorder-category-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('workorder-category-form-data-popup-index');
