...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('ops-voucher-history-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('ops-voucher-history-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('ops-voucher-history-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('ops-voucher-history-form-data-popup-index');
