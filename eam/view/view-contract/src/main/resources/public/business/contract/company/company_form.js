...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('cont-company-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('cont-company-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('cont-company-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('cont-company-form-data-popup-index');
