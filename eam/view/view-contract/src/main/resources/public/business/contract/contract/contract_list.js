...
function ListPage() {
		...
		function renderTableInternal() {
			...
			dataTable=fox.renderTable({
				...
				cols: [[
					...
					,{ field: 'name', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('合同名称') }
					,{ field: 'code', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('合同编号') }
					,{ field: 'state', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('合同状态') }
					,{ field: 'fundStatus', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('资金状态') }
					,{ field: 'categoryId', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('合同类型') }
					,{ field: 'identity', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('我方身份') }
					,{ field: 'fundDirect', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('资金流向') }
					,{ field: 'money', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('金额') }
					,{ field: 'allmoney', align:"right",fixed:false,  hide:false, sort: true, title: fox.translate('总金额') }
	...
	function bindButtonEvent() {
        ...
        function batchDelete(selected) {
            ...
            if(ids.length==0) {
            	layer.msg(fox.translate('请选择需要删除的')+fox.translate('合同')+"!");
            	return;
            }
            //调用批量删除接口
			layer.confirm(fox.translate('确定删除已选中的')+fox.translate('合同')+fox.translate('吗？'), function (i) {
				layer.close(i);
    ...
    function bindRowOperationEvent() {
		...
		table.on('tool(data-table)', function (obj) {
			...
			if (layEvent === 'edit') { // 修改
				...
				layer.confirm(fox.translate('确定删除此')+fox.translate('合同')+fox.translate('吗？'), function (i) {
					layer.close(i);
	...
	function showEditForm(data) {
		...
		var title = (data && data.id) ? (fox.translate('修改')+fox.translate('合同')) : (fox.translate('添加')+fox.translate('合同'));
