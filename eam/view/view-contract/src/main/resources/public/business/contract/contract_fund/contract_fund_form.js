...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('cont-contract-fund-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('cont-contract-fund-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('cont-contract-fund-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('cont-contract-fund-form-data-popup-index');
