...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('sys-code-rule-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('sys-code-rule-form-data');
		}
	...
	function getFormData() {
		...
		//获取 模块 下拉框的值
		data["moduleId"]=fox.getSelectedValue("moduleId",false);
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('sys-code-rule-form-data-popup-index');
