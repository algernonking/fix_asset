...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('sys-code-register-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('sys-code-register-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('sys-code-register-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('sys-code-register-form-data-popup-index');
