...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('sys-code-allocation-form-data-form-action');
		//如果没有修改和保存权限
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('sys-code-allocation-form-data');
		}
	...
	function getFormData() {
		...
		//获取 编码规则 下拉框的值
		data["ruleId"]=fox.getSelectedValue("ruleId",false);
