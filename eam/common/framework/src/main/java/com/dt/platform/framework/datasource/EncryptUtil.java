...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
        ...
        String user="root";
        String pwd="123456";
        String url="jdbc:mysql://121.43.103.102:3306/eam?useSSL=false&serverTimezone=Hongkong&useUnicode=true&characterEncoding=utf-8&autoReconnect=true&allowPublicKeyRetrieval=true&tinyInt1isBit=false";
