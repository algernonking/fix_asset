...
public class MaintainTaskVOMeta extends MaintainTaskMeta {
	...
	*/
	 ...
	 * 负责人 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskVO,java.lang.String> LEADER_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskVO.class ,LEADER_ID, java.lang.String.class, "负责人", "负责人", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ PAGE_INDEX , PAGE_SIZE , SEARCH_FIELD , FUZZY_FIELD , SEARCH_VALUE , DIRTY_FIELDS , SORT_FIELD , SORT_TYPE , IDS , ID , NAME , STATUS , LEADER_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION };
	...
	*/
	public static class $$proxy$$ extends com.dt.platform.domain.eam.MaintainTaskVO {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public MaintainTask setLeaderId(String leaderId) {
