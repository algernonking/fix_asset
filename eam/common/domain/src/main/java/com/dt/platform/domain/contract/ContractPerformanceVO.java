...
public class ContractPerformanceVO extends ContractPerformance {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ContractPerformanceVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ContractPerformanceVO addId(String id) {
