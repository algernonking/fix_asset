...
public class AssetVOMeta extends AssetMeta {
	...
	*/
	 ...
	 * 使用期限 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> SERVICE_LIFE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,SERVICE_LIFE, java.math.BigDecimal.class, "使用期限", "使用期限", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 资产RFID , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> RFID_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,RFID, java.lang.String.class, "资产RFID", "资产RFID", java.lang.String.class, null);
	...
	*/
	 ...
	 * 含税金额 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> TAX_AMOUNT_PRICE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,TAX_AMOUNT_PRICE, java.math.BigDecimal.class, "含税金额", "含税金额", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 资产总值 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> TOTAL_AMOUNT_PRICE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,TOTAL_AMOUNT_PRICE, java.math.BigDecimal.class, "资产总值", "资产总值", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 资产原值(单价) , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> ORIGINAL_UNIT_PRICE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,ORIGINAL_UNIT_PRICE, java.math.BigDecimal.class, "资产原值(单价)", "资产原值(单价)", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 资产净值 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> NAV_PRICE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,NAV_PRICE, java.math.BigDecimal.class, "资产净值", "资产净值", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 采购单价 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> PURCHASE_UNIT_PRICE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,PURCHASE_UNIT_PRICE, java.math.BigDecimal.class, "采购单价", "采购单价", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * version , 类型: java.lang.Integer
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.Integer> VERSION_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,VERSION, java.lang.Integer.class, "version", "version", java.lang.Integer.class, null);
	...
	*/
	 ...
	 * 选择 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> ASSET_SELECTED_CODE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,ASSET_SELECTED_CODE, java.lang.String.class, "选择", "选择", java.lang.String.class, null);
	...
	*/
	 ...
	 * 机柜 , 类型: com.dt.platform.domain.datacenter.Rack
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,com.dt.platform.domain.datacenter.Rack> RACK_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,RACK, com.dt.platform.domain.datacenter.Rack.class, "机柜", "机柜", com.dt.platform.domain.datacenter.Rack.class, null);
