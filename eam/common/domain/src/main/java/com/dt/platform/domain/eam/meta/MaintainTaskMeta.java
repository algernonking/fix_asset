 ...
 * @sign BBFF6ACBBFCC78346EFED4D4529CD735
...
public class MaintainTaskMeta {
	...
	*/
	 ...
	 * 负责人 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTask,java.lang.String> LEADER_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTask.class ,LEADER_ID, java.lang.String.class, "负责人", "负责人", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , STATUS , LEADER_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION };
