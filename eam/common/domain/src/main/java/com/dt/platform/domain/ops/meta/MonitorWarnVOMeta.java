...
public class MonitorWarnVOMeta extends MonitorWarnMeta {
	...
	*/
	 ...
	 * 类型 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.ops.MonitorWarnVO,java.lang.String> NODE_ID_PROP = new BeanProperty(com.dt.platform.domain.ops.MonitorWarnVO.class ,NODE_ID, java.lang.String.class, "类型", "类型", java.lang.String.class, null);
