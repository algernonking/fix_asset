...
public class AssetSoftwareDistributeVO extends AssetSoftwareDistribute {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareDistributeVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareDistributeVO addId(String id) {
