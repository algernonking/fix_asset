...
@Table(name = "ops_host_db")
public class HostDb extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =OPS_HOST_DB.$TABLE;
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public HostDb setTenantId(String tenantId) {
	...
	*/
	...
	/**
	 * 将 Map 转换成 HostDb
	 * @param hostDbMap 包含实体信息的 Map 对象
	 * @return HostDb , 转换好的的 HostDb 对象
	*/
	@Transient
	public static HostDb createFrom(Map<String,Object> hostDbMap) {
		if(hostDbMap==null) return null;
		HostDb po = EntityContext.create(HostDb.class, hostDbMap);
		return po;
	}
	...
	*/
	@Transient
	public static HostDb createFrom(Object pojo) {
		if(pojo==null) return null;
		HostDb po = EntityContext.create(HostDb.class,pojo);
		return po;
	}
	...
	*/
	@Transient
	public static HostDb create() {
		return EntityContext.create(HostDb.class);
	}
}