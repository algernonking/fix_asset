...
@Table(name = "dc_info")
public class DcInfo extends Entity {
	...
	*/
	...
	/**
	 * 将 Map 转换成 DcInfo
	 * @param dcInfoMap 包含实体信息的 Map 对象
	 * @return DcInfo , 转换好的的 DcInfo 对象
	*/
	@Transient
	public static DcInfo createFrom(Map<String,Object> dcInfoMap) {
		if(dcInfoMap==null) return null;
		DcInfo po = EntityContext.create(DcInfo.class, dcInfoMap);
		return po;
	}
	...
	*/
	@Transient
	public static DcInfo createFrom(Object pojo) {
		if(pojo==null) return null;
		DcInfo po = EntityContext.create(DcInfo.class,pojo);
		return po;
	}
	...
	*/
	@Transient
	public static DcInfo create() {
		return EntityContext.create(DcInfo.class);
	}
}