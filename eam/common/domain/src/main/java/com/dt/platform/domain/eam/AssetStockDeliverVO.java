...
public class AssetStockDeliverVO extends AssetStockDeliver {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockDeliverVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockDeliverVO addId(String id) {
