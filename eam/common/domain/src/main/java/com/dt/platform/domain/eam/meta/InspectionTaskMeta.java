...
public class InspectionTaskMeta {
	...
	*/
	 ...
	 * 名称 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTask,java.lang.String> NAME_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTask.class ,NAME, java.lang.String.class, "名称", "名称", java.lang.String.class, null);
	...
	*/
	 ...
	 * 执行结果 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTask,java.lang.String> RESULT_STATUS_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTask.class ,RESULT_STATUS, java.lang.String.class, "执行结果", "执行结果", java.lang.String.class, null);
	...
	*/
	 ...
	 * 开始时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTask,java.util.Date> START_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTask.class ,START_TIME, java.util.Date.class, "开始时间", "开始时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 完成时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTask,java.util.Date> COMPLETE_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTask.class ,COMPLETE_TIME, java.util.Date.class, "完成时间", "完成时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 应开始时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTask,java.util.Date> PLAN_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTask.class ,PLAN_TIME, java.util.Date.class, "应开始时间", "应开始时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , PLAN_ID , RESULT_STATUS , START_TIME , COMPLETE_TIME , PLAN_TIME , CONTENT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION , INSPECTION_PLAN };
