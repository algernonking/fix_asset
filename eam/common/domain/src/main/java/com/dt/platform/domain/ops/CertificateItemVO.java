...
public class CertificateItemVO extends CertificateItem {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CertificateItemVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CertificateItemVO addId(String... id) {
