 ...
 * @sign 5F43F082421BE8FEBE16C481BD9C06AE
...
public class AssetStockGoodsInMeta {
	...
	*/
	 ...
	 * 库存所属 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> OWNER_CODE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,OWNER_CODE, java.lang.String.class, "库存所属", "库存所属", java.lang.String.class, null);
	...
	*/
	 ...
	 * 库存类型 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> STOCK_TYPE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,STOCK_TYPE, java.lang.String.class, "库存类型", "库存类型", java.lang.String.class, null);
	...
	*/
	 ...
	 * 批次号 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> STOCK_BATCH_CODE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,STOCK_BATCH_CODE, java.lang.String.class, "批次号", "批次号", java.lang.String.class, null);
	...
	*/
	 ...
	 * 单据名称 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> STOCK_NAME_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,STOCK_NAME, java.lang.String.class, "单据名称", "单据名称", java.lang.String.class, null);
	...
	*/
	 ...
	 * 资产供应商 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> SUPPLIER_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,SUPPLIER_ID, java.lang.String.class, "资产供应商", "资产供应商", java.lang.String.class, null);
	...
	*/
	 ...
	 * 备注 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetStockGoodsIn,java.lang.String> STOCK_NOTES_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetStockGoodsIn.class ,STOCK_NOTES, java.lang.String.class, "备注", "备注", java.lang.String.class, null);
	...
	*/
	public static class $$proxy$$ extends com.dt.platform.domain.eam.AssetStockGoodsIn {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public AssetStockGoodsIn setOwnerCode(String ownerCode) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public AssetStockGoodsIn setStockBatchCode(String stockBatchCode) {
		 ...
		 * @return 当前对象
		*/
		public AssetStockGoodsIn setStockName(String stockName) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public AssetStockGoodsIn setSupplierId(String supplierId) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public AssetStockGoodsIn setStockNotes(String stockNotes) {
