 ...
 * @sign A0189B3BBF7C75E78B5C5E482CA367C4
...
public class AssetAllocationMeta {
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , BUSINESS_CODE , PROC_ID , STATUS , ORIGINATOR_ID , OUT_MANAGEMENT_ORGANIZATION_ID , IN_MANAGEMENT_ORGANIZATION_ID , MANAGER_ID , CONTENT , BUSINESS_DATE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION };
