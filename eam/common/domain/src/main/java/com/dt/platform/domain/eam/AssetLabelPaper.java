...
public class AssetLabelPaper extends Entity {
	...
	*/
	 ...
	 * 类型：paper|special
	*/
	@ApiModelProperty(required = false,value="类型" , notes = "paper|special")
	private String type;
	
	/**
	 * 列数：列数
	*/
	@ApiModelProperty(required = false,value="列数" , notes = "列数")
	...
	*/
	...
	public static AssetLabelPaper createFrom(Map<String,Object> assetLabelPaperMap) {
		...
		AssetLabelPaper po = EntityContext.create(AssetLabelPaper.class, assetLabelPaperMap);
		return po;
	}
	...
	*/
	...
	public static AssetLabelPaper createFrom(Object pojo) {
		...
		AssetLabelPaper po = EntityContext.create(AssetLabelPaper.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AssetLabelPaper create() {
		return EntityContext.create(AssetLabelPaper.class);
	}
}