...
public class AssetLabelTplItemVO extends AssetLabelTplItem {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetLabelTplItemVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetLabelTplItemVO addId(String id) {
