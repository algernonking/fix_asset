...
public class AssetSoftwareMaintenanceVO extends AssetSoftwareMaintenance {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareMaintenanceVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareMaintenanceVO addId(String id) {
