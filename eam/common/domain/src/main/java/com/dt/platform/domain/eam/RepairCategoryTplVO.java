...
public class RepairCategoryTplVO extends RepairCategoryTpl {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public RepairCategoryTplVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public RepairCategoryTplVO addId(String... id) {
