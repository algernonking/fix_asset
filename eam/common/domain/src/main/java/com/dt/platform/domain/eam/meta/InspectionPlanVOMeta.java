...
public class InspectionPlanVOMeta extends InspectionPlanMeta {
	...
	*/
	 ...
	 * 超时(小时) , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionPlanVO,java.math.BigDecimal> TIMEOUT_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionPlanVO.class ,TIMEOUT, java.math.BigDecimal.class, "超时(小时)", "超时(小时)", java.math.BigDecimal.class, null);
