...
public class AssetStockGoodsDetailVO extends AssetStockGoodsDetail {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockGoodsDetailVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockGoodsDetailVO addId(String id) {
