...
public class AssetSoftwareChangeVO extends AssetSoftwareChange {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareChangeVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareChangeVO addId(String id) {
