...
public class AssetSoftwareChangeDetailVO extends AssetSoftwareChangeDetail {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareChangeDetailVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetSoftwareChangeDetailVO addId(String id) {
