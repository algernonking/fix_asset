...
import com.dt.platform.constants.db.EAMTables.OPS_SERVICE;
 ...
 * @since 2021-08-12 13:24:45
 * @sign C5CCA2FA8CB3419E1539F0273C657AB6
 * 此文件由工具自动生成，请勿修改。若表结构或配置发生变动，请使用工具重新生成。
*/

@Table(name = "ops_service")
public class OpsService extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =OPS_SERVICE.$TABLE;
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return OpsService , 转换好的 OpsService 对象
	*/
	@Transient
	 ...
	 * @return OpsService , 转换好的 PoJo 对象
	*/
	@Transient
	...
	/**
	 * 将 Map 转换成 OpsService
	 * @param opsServiceMap 包含实体信息的 Map 对象
	 * @return OpsService , 转换好的的 OpsService 对象
	*/
	@Transient
	public static OpsService createFrom(Map<String,Object> opsServiceMap) {
		if(opsServiceMap==null) return null;
		OpsService po = EntityContext.create(OpsService.class, opsServiceMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 OpsService
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return OpsService , 转换好的的 OpsService 对象
	*/
	@Transient
	public static OpsService createFrom(Object pojo) {
		if(pojo==null) return null;
		OpsService po = EntityContext.create(OpsService.class,pojo);
		return po;
	}

	/**
	 * 创建一个 OpsService，等同于 new
	 * @return OpsService 对象
	*/
	@Transient
	public static OpsService create() {
		return EntityContext.create(OpsService.class);
	}
}