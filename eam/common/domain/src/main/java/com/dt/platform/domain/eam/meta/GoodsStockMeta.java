...
public class GoodsStockMeta {
	...
	*/
	 ...
	 * 入库存数量 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.GoodsStock,java.math.BigDecimal> STOCK_IN_NUMBER_PROP = new BeanProperty(com.dt.platform.domain.eam.GoodsStock.class ,STOCK_IN_NUMBER, java.math.BigDecimal.class, "入库存数量", "入库存数量", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 当前库存数量 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.GoodsStock,java.math.BigDecimal> STOCK_CUR_NUMBER_PROP = new BeanProperty(com.dt.platform.domain.eam.GoodsStock.class ,STOCK_CUR_NUMBER, java.math.BigDecimal.class, "当前库存数量", "当前库存数量", java.math.BigDecimal.class, null);
