...
public class AssetSoftwareDistributeMeta {
	...
	*/
	 ...
	 * 资产分类 , 类型: com.dt.platform.domain.eam.Asset
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetSoftwareDistribute,com.dt.platform.domain.eam.Asset> ASSET_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetSoftwareDistribute.class ,ASSET, com.dt.platform.domain.eam.Asset.class, "资产分类", "资产分类", com.dt.platform.domain.eam.Asset.class, null);
