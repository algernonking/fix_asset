	...
	*/
	public static class EAM_ASSET_STORAGE extends DBTable {
		...
		*/
		...
		/**
		*/
		public static final DBField SELECTED_CODE = new DBField(DBDataType.STRING , "selected_code","selectedCode","selected_code","selected_code",false,false,true);
