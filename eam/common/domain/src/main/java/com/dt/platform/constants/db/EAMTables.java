...
public class EAMTables {
	...
	*/
	public static class EAM_ASSET extends DBTable {
		...
		*/
		 ...
		 * 批次代码
		*/
		public static final DBField BATCH_CODE = new DBField(DBDataType.STRING , "batch_code","batchCode","批次代码","批次代码",false,false,false);
	...
	*/
	public static class EAM_ASSET_CHANGE extends DBTable {
		...
		*/
		 ...
		 * 变更数量
		*/
		public static final DBField CHANGE_COUNT = new DBField(DBDataType.DECIMAL , "change_count","changeCount","变更数量","变更数量",false,false,true);
		...
		*/
		...
		public EAM_ASSET_CHANGE() {
			this.init($NAME,"资产变更" , ID , NAME , CODE , TYPE , CHANGE_COUNT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class EAM_ASSET_EXT_EQUIPMENT extends DBTable {
		...
		*/
		...
		public EAM_ASSET_EXT_EQUIPMENT() {
			this.init($NAME,"设备属性扩展" , ID , ASSET_ID , EQUIPMENT_IP , MANAGE_IP , EQUIPMENT_CPU , EQUIPMENT_MEMORY , EQUIPMENT_NOTES , EQUIPMENT_DESC , RACK_ID , RACK_UP_POSITION_NUMBER , RACK_DOWN_POSITION_NUMBER , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class EAM_ASSET_EXT_MAINTAINER extends DBTable {
		...
		*/
		 ...
		 * 维保开始时间
		*/
		public static final DBField MAINTENANCE_STARTTIME = new DBField(DBDataType.DATE , "maintenance_starttime","maintenanceStarttime","维保开始时间","维保开始时间",false,false,true);
		
		/**
		 * 维保到期时间
		*/
		public static final DBField MAINTENANCE_ENDTIME = new DBField(DBDataType.DATE , "maintenance_endtime","maintenanceEndtime","维保到期时间","维保到期时间",false,false,true);
		...
		*/
		...
		public EAM_ASSET_EXT_MAINTAINER() {
			this.init($NAME,"资产维保属性" , ID , ASSET_ID , MAINTAINER_ID , MAINTENANCE_STARTTIME , MAINTENANCE_ENDTIME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class EAM_CATEGORY_FINANCE extends DBTable {
		...
		*/
		...
		public EAM_CATEGORY_FINANCE() {
			this.init($NAME,"资产财务分类" , ID , STATUS , CATEGORY_NAME , CATEGORY_FULLNAME , CATEGORY_CODE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class KN_CATEGORY extends DBTable {
		...
		*/
		...
		public KN_CATEGORY() {
			this.init($NAME,"知识分类" , ID , STATUS , CATEGORY_NAME , CATEGORY_FULLNAME , CATEGORY_CODE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class KN_CONTENT extends DBTable {
		...
		*/
		 ...
		 * 内容类型
		*/
		public static final DBField ONTENT_TYPE = new DBField(DBDataType.STRING , "ontent_type","ontentType","内容类型","内容类型",false,false,true);
		
		/**
		*/
		public static final DBField REVIEW_COUNT = new DBField(DBDataType.DECIMAL , "review_count","reviewCount","review_count","review_count",false,false,true);
		...
		*/
		 ...
		 * 显示
		*/
		public static final DBField DISPLAY = new DBField(DBDataType.INTEGER , "display","display","显示","显示",false,false,true);
		
		/**
		 * 分享
		*/
		public static final DBField SHARE_URL = new DBField(DBDataType.STRING , "share_url","shareUrl","分享","分享",false,false,true);
		...
		*/
		...
		public KN_CONTENT() {
			this.init($NAME,"知识库内容" , ID , CATEGORY_ID , TITLE , PROFILE , KEY_WORDS , LABEL , CONTENT , ONTENT_TYPE , REVIEW_COUNT , ATTACH , DISPLAY , SHARE_URL , GRADE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	 ...
	 * 知识分级
	*/
	public static class KN_GRADE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "kn_grade";
		...
		*/
		 ...
		 * 编号
		*/
		public static final DBField CODE = new DBField(DBDataType.INTEGER , "code","code","编号","编号",false,false,true);
		...
		*/
		...
		public KN_GRADE() {
			this.init($NAME,"知识分级" , ID , CODE , NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final KN_GRADE $TABLE=new KN_GRADE();
	}
	...
	*/
	public static class OPS_SERVICE_CATEGORY extends DBTable {
		...
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","服务分组DB","OS,MIDDLEWARE,OTHER",false,false,true);
	...
	*/
	public static class OPS_SERVICE_INFO extends DBTable {
		...
		*/
		 ...
		 * 服务ID
		*/
		public static final DBField SERVICE_CATEGORY_ID = new DBField(DBDataType.STRING , "service_category_id","serviceCategoryId","服务ID","服务ID",false,false,true);
