	...
	*/
	public static class EAM_ASSET_BORROW extends DBTable {
		...
		*/
		 ...
		 * 借用时间
		*/
		public static final DBField BORROW_DATE = new DBField(DBDataType.DATE , "borrow_date","borrowDate","借用时间","借用时间",false,false,true);
		...
		*/
		...
		public EAM_ASSET_BORROW() {
			this.init($NAME,"资产借用" , ID , NAME , BUSINESS_CODE , PROC_ID , STATUS , BUSINESS_DATE , ORIGINATOR_ID , BORROWER_ID , BORROW_DATE , PLAN_RETURN_DATE , CONTENT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class EAM_ASSET_COLLECTION extends DBTable {
		...
		*/
		...
		public EAM_ASSET_COLLECTION() {
			this.init($NAME,"资产领用" , ID , NAME , BUSINESS_CODE , PROC_ID , STATUS , BUSINESS_DATE , ORIGINATOR_ID , ACTUAL_COLLECTION_DATE , USER_ORGANIZATION_ID , USER_ID , POSITION_ID , POSITION_DETAIL , CONTENT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class EAM_ASSET_EXT_MAINTAINER extends DBTable {
		...
		*/
		 ...
		 * 联系方式
		*/
		public static final DBField CONTACT_INFORMATION = new DBField(DBDataType.STRING , "contact information","contact information","联系方式","联系方式",false,false,true);
	...
	public static class EAM_ASSET_REPAIR extends DBTable {
		...
		*/
		...
		public EAM_ASSET_REPAIR() {
			this.init($NAME,"资产报修" , ID , NAME , BUSINESS_CODE , PROC_ID , STATUS , BUSINESS_DATE , ORIGINATOR_ID , REPAIR_STATUS , TYPE , PLAN_FINISH_DATE , ACTUAL_FINISH_DATE , CONTENT , OPERUSER_ID , PICTURE_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
