...
import com.dt.platform.constants.db.EAMTables.CONT_CONTRACT_CATEGORY;
 ...
 * @sign 75C8608B9A0AA080C5F93C48A050C2E1
 * 此文件由工具自动生成，请勿修改。若表结构或配置发生变动，请使用工具重新生成。
*/

@Table(name = "cont_contract_category")
public class ContractCategory extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =CONT_CONTRACT_CATEGORY.$TABLE;
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ContractCategory setTenantId(String tenantId) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ContractCategory , 转换好的 ContractCategory 对象
	*/
	@Transient
	 ...
	 * @return ContractCategory , 转换好的 PoJo 对象
	*/
	@Transient
	...
	/**
	 * 将 Map 转换成 ContractCategory
	 * @param contractCategoryMap 包含实体信息的 Map 对象
	 * @return ContractCategory , 转换好的的 ContractCategory 对象
	*/
	@Transient
	public static ContractCategory createFrom(Map<String,Object> contractCategoryMap) {
		if(contractCategoryMap==null) return null;
		ContractCategory po = EntityContext.create(ContractCategory.class, contractCategoryMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 ContractCategory
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ContractCategory , 转换好的的 ContractCategory 对象
	*/
	@Transient
	public static ContractCategory createFrom(Object pojo) {
		if(pojo==null) return null;
		ContractCategory po = EntityContext.create(ContractCategory.class,pojo);
		return po;
	}

	/**
	 * 创建一个 ContractCategory，等同于 new
	 * @return ContractCategory 对象
	*/
	@Transient
	public static ContractCategory create() {
		return EntityContext.create(ContractCategory.class);
	}
}