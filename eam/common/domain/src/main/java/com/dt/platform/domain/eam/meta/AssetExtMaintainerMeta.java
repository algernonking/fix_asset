...
public class AssetExtMaintainerMeta {
	...
	*/
	 ...
	 * 资产ID , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetExtMaintainer,java.lang.String> ASSET_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetExtMaintainer.class ,ASSET_ID, java.lang.String.class, "资产ID", "资产ID", java.lang.String.class, null);
	...
	*/
	public static final String MAINTENANCE_STARTTIME="maintenanceStarttime";
	
	/**
	 * 维保开始时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetExtMaintainer,java.util.Date> MAINTENANCE_STARTTIME_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetExtMaintainer.class ,MAINTENANCE_STARTTIME, java.util.Date.class, "维保开始时间", "维保开始时间", java.util.Date.class, null);
	
	/**
	 * 维保到期时间 , 类型: java.util.Date
	*/
	public static final String MAINTENANCE_ENDTIME="maintenanceEndtime";
	
	/**
	 * 维保到期时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetExtMaintainer,java.util.Date> MAINTENANCE_ENDTIME_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetExtMaintainer.class ,MAINTENANCE_ENDTIME, java.util.Date.class, "维保到期时间", "维保到期时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , ASSET_ID , MAINTAINER_ID , MAINTENANCE_STARTTIME , MAINTENANCE_ENDTIME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION };
	...
	public static class $$proxy$$ extends com.dt.platform.domain.eam.AssetExtMaintainer {
		...
		*/
		public AssetExtMaintainer setMaintenanceStarttime(Date maintenanceStarttime) {
			super.change(MAINTENANCE_STARTTIME,super.getMaintenanceStarttime(),maintenanceStarttime);
		...
		*/
		public AssetExtMaintainer setMaintenanceEndtime(Date maintenanceEndtime) {
			super.change(MAINTENANCE_ENDTIME,super.getMaintenanceEndtime(),maintenanceEndtime);
