...
public class AssetDataPermissionsOrgVO extends AssetDataPermissionsOrg {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetDataPermissionsOrgVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetDataPermissionsOrgVO addId(String id) {
