...
public class MonitorNodeListValueVO extends MonitorNodeListValue {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public MonitorNodeListValueVO addDirtyField(String dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public MonitorNodeListValueVO addId(String id) {
