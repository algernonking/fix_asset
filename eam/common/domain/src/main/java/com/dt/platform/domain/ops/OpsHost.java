...
@Table(name = "ops_host")
public class OpsHost extends Entity {
	...
	*/
	 ...
	 * 运行环境prod：uat,tst
	*/
	@ApiModelProperty(required = false,value="运行环境prod" , notes = "uat,tst")
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return OpsHost , 转换好的 OpsHost 对象
	*/
	@Transient
	...
	*/
	...
	/**
	 * 将 Map 转换成 OpsHost
	 * @param opsHostMap 包含实体信息的 Map 对象
	 * @return OpsHost , 转换好的的 OpsHost 对象
	*/
	@Transient
	public static OpsHost createFrom(Map<String,Object> opsHostMap) {
		if(opsHostMap==null) return null;
		OpsHost po = EntityContext.create(OpsHost.class, opsHostMap);
		return po;
	}
	...
	*/
	@Transient
	public static OpsHost createFrom(Object pojo) {
		if(pojo==null) return null;
		OpsHost po = EntityContext.create(OpsHost.class,pojo);
		return po;
	}

	/**
	 * 创建一个 OpsHost，等同于 new
	 * @return OpsHost 对象
	*/
	@Transient
	public static OpsHost create() {
		return EntityContext.create(OpsHost.class);
	}
}