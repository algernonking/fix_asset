...
import com.dt.platform.constants.db.EAMTables.EAM_REPAIR_CATEGORY;
...
@Table(name = "eam_repair_category")
public class RepairCategory extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =EAM_REPAIR_CATEGORY.$TABLE;
	...
	*/
	@Transient
	public RepairCategory setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return RepairCategory , 转换好的 RepairCategory 对象
	*/
	@Transient
	 ...
	 * @return RepairCategory , 转换好的 PoJo 对象
	*/
	@Transient
	...
	/**
	 * 将 Map 转换成 RepairCategory
	 * @param repairCategoryMap 包含实体信息的 Map 对象
	 * @return RepairCategory , 转换好的的 RepairCategory 对象
	*/
	@Transient
	public static RepairCategory createFrom(Map<String,Object> repairCategoryMap) {
		if(repairCategoryMap==null) return null;
		RepairCategory po = EntityContext.create(RepairCategory.class, repairCategoryMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 RepairCategory
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return RepairCategory , 转换好的的 RepairCategory 对象
	*/
	@Transient
	public static RepairCategory createFrom(Object pojo) {
		if(pojo==null) return null;
		RepairCategory po = EntityContext.create(RepairCategory.class,pojo);
		return po;
	}

	/**
	 * 创建一个 RepairCategory，等同于 new
	 * @return RepairCategory 对象
	*/
	@Transient
	public static RepairCategory create() {
		return EntityContext.create(RepairCategory.class);
	}
}