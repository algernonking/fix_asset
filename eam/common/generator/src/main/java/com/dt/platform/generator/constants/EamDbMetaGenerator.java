...
public class EamDbMetaGenerator  {
	...
	private void buildDBMeta() {
		...
		dbMetaBuilder.setTableFilter(table->{
			...
			if( table.startsWith("fz_")|| table.startsWith("rfid_")|| table.startsWith("kn_") ||table.startsWith("workorder_")||    table.startsWith("sys_tpl")||  table.startsWith("sys_code") ||table.startsWith("eam_") || table.startsWith("hrm_") || table.startsWith("dc_") || table.startsWith("ops_")) return true;
			return false;
		});
