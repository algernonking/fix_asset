...
import com.dt.platform.eam.page.AssetStockGoodsOutPageController;
import com.dt.platform.generator.config.Config;
import com.dt.platform.proxy.eam.AssetStockGoodsOutServiceProxy;
import com.github.foxnic.generator.config.WriteMode;

public class StockGoodsOut extends BaseCodeGenerator {


    public StockGoodsOut() {
    ...
    public void generateCode() throws Exception {
        ...
        cfg.view().search().inputLayout(
                new Object[]{
                        EAMTables.EAM_ASSET_STOCK_GOODS_OUT.ID,
    ...
    public static void main(String[] args) throws Exception {
        StockGoodsOut g=new StockGoodsOut();
        //生成代码
       g.generateCode();
