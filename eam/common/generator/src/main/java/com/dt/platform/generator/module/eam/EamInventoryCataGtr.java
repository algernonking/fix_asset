...
public class EamInventoryCataGtr extends BaseCodeGenerator{
    ...
    public EamInventoryCataGtr() {
        super(EAMTables.EAM_INVENTORY_CATALOG.$TABLE,BASIC_DATA_MENU_ID);
    }
    ...
    public void generateCode() throws Exception {
     ...
     //   cfg.getPoClassFile().addSimpleProperty(Employee.class,"inventoryDirector","盘点负责人","盘点负责人");
        cfg.view().field(EAMTables.EAM_INVENTORY_CATALOG.ID).basic().hidden(true);

        //eam_asset_change_data
        cfg.view().search().inputLayout(
                new Object[]{
                        EAMTables.EAM_INVENTORY_CATALOG.ID
                }
        );
    ...
    public static void main(String[] args) throws Exception {
        EamInventoryCataGtr g=new EamInventoryCataGtr();
