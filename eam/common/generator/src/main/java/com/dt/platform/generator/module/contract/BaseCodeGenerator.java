...
public class BaseCodeGenerator {
    ...
    public static final String BASIC_MGR_MENU_ID="485415810584555521";
    public static final String BASIC_SETTING_MENU_ID="485395845907230720";
    public static final String BASIC_BOOK_MENU_ID="474158548662616065";

    //
    private String appId="service-contract";

    private String appConfigPrefix= "service-contract";
    ...
    private String tablePrefix="cont_";
