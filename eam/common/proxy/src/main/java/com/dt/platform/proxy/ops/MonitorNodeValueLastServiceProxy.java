...
;
	...
	*/
	...
	Result insert(MonitorNodeValueLastVO monitorNodeValueLastVO);
	...
	*/
	...
	Result update(MonitorNodeValueLastVO monitorNodeValueLastVO);

	/**
	 * 更新节点数值最新
	*/
	@RequestMapping(MonitorNodeValueLastServiceProxy.SAVE)
	Result save(MonitorNodeValueLastVO monitorNodeValueLastVO);

	/**
	 * 获取节点数值最新
	*/
	@RequestMapping(MonitorNodeValueLastServiceProxy.GET_BY_ID)
	Result<MonitorNodeValueLast> getById(String id);

	/**
	 * 获取多个节点数值最新
	*/
	@RequestMapping(MonitorNodeValueLastServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeValueLast>> getByIds(List<String> ids);
	/**
	 * 查询节点数值最新
	*/
	@RequestMapping(MonitorNodeValueLastServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeValueLast>> queryList(MonitorNodeValueLastVO sample);

	/**
	 * 分页查询节点数值最新
	*/
	@RequestMapping(MonitorNodeValueLastServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeValueLast>> queryPagedList(MonitorNodeValueLastVO sample);
