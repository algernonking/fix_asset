...
public interface VoucherServiceProxy {
	...
	*/
	...
	Result insert(VoucherVO voucherVO);
	...
	*/
	...
	Result update(VoucherVO voucherVO);
	
	/**
	 * 更新凭证
	*/
	@RequestMapping(VoucherServiceProxy.SAVE)
	Result save(VoucherVO voucherVO);
	
	/**
	 * 获取凭证
	*/
	@RequestMapping(VoucherServiceProxy.GET_BY_ID)
	Result<Voucher> getById(String id);

	/**
	 * 批量删除凭证
	*/
	@RequestMapping(VoucherServiceProxy.GET_BY_IDS)
	Result<List<Voucher>> getByIds(List<String> ids);
	/**
	 * 查询凭证
	*/
	@RequestMapping(VoucherServiceProxy.QUERY_LIST)
	Result<List<Voucher>> queryList(VoucherVO sample);
	
	/**
	 * 分页查询凭证
	*/
	@RequestMapping(VoucherServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<Voucher>> queryPagedList(VoucherVO sample);
