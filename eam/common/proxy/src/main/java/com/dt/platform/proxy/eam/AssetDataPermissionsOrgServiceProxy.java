...
;
	...
	*/
	...
	Result insert(AssetDataPermissionsOrgVO assetDataPermissionsOrgVO);
	...
	*/
	...
	Result update(AssetDataPermissionsOrgVO assetDataPermissionsOrgVO);

	/**
	 * 更新组织
	*/
	@RequestMapping(AssetDataPermissionsOrgServiceProxy.SAVE)
	Result save(AssetDataPermissionsOrgVO assetDataPermissionsOrgVO);

	/**
	 * 获取组织
	*/
	@RequestMapping(AssetDataPermissionsOrgServiceProxy.GET_BY_ID)
	Result<AssetDataPermissionsOrg> getById(String id);

	/**
	 * 获取多个组织
	*/
	@RequestMapping(AssetDataPermissionsOrgServiceProxy.GET_BY_IDS)
	Result<List<AssetDataPermissionsOrg>> getByIds(List<String> ids);
	/**
	 * 查询组织
	*/
	@RequestMapping(AssetDataPermissionsOrgServiceProxy.QUERY_LIST)
	Result<List<AssetDataPermissionsOrg>> queryList(AssetDataPermissionsOrgVO sample);

	/**
	 * 分页查询组织
	*/
	@RequestMapping(AssetDataPermissionsOrgServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetDataPermissionsOrg>> queryPagedList(AssetDataPermissionsOrgVO sample);
