...
;
	...
	*/
	...
	Result insert(AssetDataPermissionsPositionVO assetDataPermissionsPositionVO);
	...
	*/
	...
	Result update(AssetDataPermissionsPositionVO assetDataPermissionsPositionVO);

	/**
	 * 更新位置
	*/
	@RequestMapping(AssetDataPermissionsPositionServiceProxy.SAVE)
	Result save(AssetDataPermissionsPositionVO assetDataPermissionsPositionVO);

	/**
	 * 获取位置
	*/
	@RequestMapping(AssetDataPermissionsPositionServiceProxy.GET_BY_ID)
	Result<AssetDataPermissionsPosition> getById(String id);

	/**
	 * 获取多个位置
	*/
	@RequestMapping(AssetDataPermissionsPositionServiceProxy.GET_BY_IDS)
	Result<List<AssetDataPermissionsPosition>> getByIds(List<String> ids);
	/**
	 * 查询位置
	*/
	@RequestMapping(AssetDataPermissionsPositionServiceProxy.QUERY_LIST)
	Result<List<AssetDataPermissionsPosition>> queryList(AssetDataPermissionsPositionVO sample);

	/**
	 * 分页查询位置
	*/
	@RequestMapping(AssetDataPermissionsPositionServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetDataPermissionsPosition>> queryPagedList(AssetDataPermissionsPositionVO sample);
