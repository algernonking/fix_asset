...
;
	...
	*/
	...
	Result insert(MonitorNodeTypeVO monitorNodeTypeVO);
	...
	*/
	...
	Result update(MonitorNodeTypeVO monitorNodeTypeVO);

	/**
	 * 更新节点类型
	*/
	@RequestMapping(MonitorNodeTypeServiceProxy.SAVE)
	Result save(MonitorNodeTypeVO monitorNodeTypeVO);

	/**
	 * 获取节点类型
	*/
	@RequestMapping(MonitorNodeTypeServiceProxy.GET_BY_ID)
	Result<MonitorNodeType> getById(String id);

	/**
	 * 获取多个节点类型
	*/
	@RequestMapping(MonitorNodeTypeServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeType>> getByIds(List<String> ids);
	/**
	 * 查询节点类型
	*/
	@RequestMapping(MonitorNodeTypeServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeType>> queryList(MonitorNodeTypeVO sample);

	/**
	 * 分页查询节点类型
	*/
	@RequestMapping(MonitorNodeTypeServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeType>> queryPagedList(MonitorNodeTypeVO sample);
