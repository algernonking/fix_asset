...
;
	...
	*/
	...
	Result insert(MonitorNodeSubtypeVO monitorNodeSubtypeVO);
	...
	*/
	...
	Result update(MonitorNodeSubtypeVO monitorNodeSubtypeVO);

	/**
	 * 更新节点子类型
	*/
	@RequestMapping(MonitorNodeSubtypeServiceProxy.SAVE)
	Result save(MonitorNodeSubtypeVO monitorNodeSubtypeVO);

	/**
	 * 获取节点子类型
	*/
	@RequestMapping(MonitorNodeSubtypeServiceProxy.GET_BY_ID)
	Result<MonitorNodeSubtype> getById(String id);

	/**
	 * 获取多个节点子类型
	*/
	@RequestMapping(MonitorNodeSubtypeServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeSubtype>> getByIds(List<String> ids);
	/**
	 * 查询节点子类型
	*/
	@RequestMapping(MonitorNodeSubtypeServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeSubtype>> queryList(MonitorNodeSubtypeVO sample);

	/**
	 * 分页查询节点子类型
	*/
	@RequestMapping(MonitorNodeSubtypeServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeSubtype>> queryPagedList(MonitorNodeSubtypeVO sample);
