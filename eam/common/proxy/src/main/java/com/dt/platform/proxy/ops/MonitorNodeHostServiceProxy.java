...
;
	...
	*/
	...
	Result insert(MonitorNodeHostVO monitorNodeHostVO);
	...
	*/
	...
	Result update(MonitorNodeHostVO monitorNodeHostVO);

	/**
	 * 更新节点主机
	*/
	@RequestMapping(MonitorNodeHostServiceProxy.SAVE)
	Result save(MonitorNodeHostVO monitorNodeHostVO);

	/**
	 * 获取节点主机
	*/
	@RequestMapping(MonitorNodeHostServiceProxy.GET_BY_ID)
	Result<MonitorNodeHost> getById(String id);

	/**
	 * 获取多个节点主机
	*/
	@RequestMapping(MonitorNodeHostServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeHost>> getByIds(List<String> ids);
	/**
	 * 查询节点主机
	*/
	@RequestMapping(MonitorNodeHostServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeHost>> queryList(MonitorNodeHostVO sample);

	/**
	 * 分页查询节点主机
	*/
	@RequestMapping(MonitorNodeHostServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeHost>> queryPagedList(MonitorNodeHostVO sample);
