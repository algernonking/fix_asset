...
public interface AssetCollectionServiceProxy {
	...
	*/
	...
	Result update(AssetCollectionVO assetCollectionVO);
	
	/**
	 * 更新资产领用
	*/
	@RequestMapping(AssetCollectionServiceProxy.SAVE)
	Result save(AssetCollectionVO assetCollectionVO);
	
	/**
	 * 获取资产领用
	*/
	@RequestMapping(AssetCollectionServiceProxy.GET_BY_ID)
	Result<AssetCollection> getById(String id);

	/**
	 * 批量删除资产领用
	*/
	@RequestMapping(AssetCollectionServiceProxy.GET_BY_IDS)
	Result<List<AssetCollection>> getByIds(List<String> ids);
	/**
	 * 查询资产领用
	*/
	@RequestMapping(AssetCollectionServiceProxy.QUERY_LIST)
	Result<List<AssetCollection>> queryList(AssetCollectionVO sample);
	
	/**
	 * 分页查询资产领用
	*/
	@RequestMapping(AssetCollectionServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetCollection>> queryPagedList(AssetCollectionVO sample);
