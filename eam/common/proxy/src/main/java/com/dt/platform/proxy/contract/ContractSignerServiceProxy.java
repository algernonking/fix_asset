...
;
	...
	*/
	...
	Result insert(ContractSignerVO contractSignerVO);
	...
	*/
	...
	Result update(ContractSignerVO contractSignerVO);

	/**
	 * 更新合同签订方
	*/
	@RequestMapping(ContractSignerServiceProxy.SAVE)
	Result save(ContractSignerVO contractSignerVO);

	/**
	 * 获取合同签订方
	*/
	@RequestMapping(ContractSignerServiceProxy.GET_BY_ID)
	Result<ContractSigner> getById(String id);

	/**
	 * 获取多个合同签订方
	*/
	@RequestMapping(ContractSignerServiceProxy.GET_BY_IDS)
	Result<List<ContractSigner>> getByIds(List<String> ids);
	/**
	 * 查询合同签订方
	*/
	@RequestMapping(ContractSignerServiceProxy.QUERY_LIST)
	Result<List<ContractSigner>> queryList(ContractSignerVO sample);

	/**
	 * 分页查询合同签订方
	*/
	@RequestMapping(ContractSignerServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<ContractSigner>> queryPagedList(ContractSignerVO sample);
