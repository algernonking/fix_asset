...
;
	...
	*/
	...
	Result insert(PurchaseOrderVO purchaseOrderVO);
	...
	*/
	...
	Result update(PurchaseOrderVO purchaseOrderVO);

	/**
	 * 更新采购订单
	*/
	@RequestMapping(PurchaseOrderServiceProxy.SAVE)
	Result save(PurchaseOrderVO purchaseOrderVO);

	/**
	 * 获取采购订单
	*/
	@RequestMapping(PurchaseOrderServiceProxy.GET_BY_ID)
	Result<PurchaseOrder> getById(String id);

	/**
	 * 获取多个采购订单
	*/
	@RequestMapping(PurchaseOrderServiceProxy.GET_BY_IDS)
	Result<List<PurchaseOrder>> getByIds(List<String> ids);
	/**
	 * 查询采购订单
	*/
	@RequestMapping(PurchaseOrderServiceProxy.QUERY_LIST)
	Result<List<PurchaseOrder>> queryList(PurchaseOrderVO sample);

	/**
	 * 分页查询采购订单
	*/
	@RequestMapping(PurchaseOrderServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<PurchaseOrder>> queryPagedList(PurchaseOrderVO sample);
