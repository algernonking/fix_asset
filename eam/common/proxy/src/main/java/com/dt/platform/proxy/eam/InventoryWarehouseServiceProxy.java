...
;
	...
	*/
	...
	Result insert(InventoryWarehouseVO inventoryWarehouseVO);
	...
	*/
	...
	Result update(InventoryWarehouseVO inventoryWarehouseVO);

	/**
	 * 更新盘点仓库
	*/
	@RequestMapping(InventoryWarehouseServiceProxy.SAVE)
	Result save(InventoryWarehouseVO inventoryWarehouseVO);

	/**
	 * 获取盘点仓库
	*/
	@RequestMapping(InventoryWarehouseServiceProxy.GET_BY_ID)
	Result<InventoryWarehouse> getById(String id);

	/**
	 * 获取多个盘点仓库
	*/
	@RequestMapping(InventoryWarehouseServiceProxy.GET_BY_IDS)
	Result<List<InventoryWarehouse>> getByIds(List<String> ids);
	/**
	 * 查询盘点仓库
	*/
	@RequestMapping(InventoryWarehouseServiceProxy.QUERY_LIST)
	Result<List<InventoryWarehouse>> queryList(InventoryWarehouseVO sample);

	/**
	 * 分页查询盘点仓库
	*/
	@RequestMapping(InventoryWarehouseServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryWarehouse>> queryPagedList(InventoryWarehouseVO sample);
