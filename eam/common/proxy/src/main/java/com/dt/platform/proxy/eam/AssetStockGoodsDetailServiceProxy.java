...
;
	...
	*/
	...
	Result insert(AssetStockGoodsDetailVO assetStockGoodsDetailVO);
	...
	*/
	...
	Result update(AssetStockGoodsDetailVO assetStockGoodsDetailVO);

	/**
	 * 更新库存物品明细
	*/
	@RequestMapping(AssetStockGoodsDetailServiceProxy.SAVE)
	Result save(AssetStockGoodsDetailVO assetStockGoodsDetailVO);

	/**
	 * 获取库存物品明细
	*/
	@RequestMapping(AssetStockGoodsDetailServiceProxy.GET_BY_ID)
	Result<AssetStockGoodsDetail> getById(String id);

	/**
	 * 获取多个库存物品明细
	*/
	@RequestMapping(AssetStockGoodsDetailServiceProxy.GET_BY_IDS)
	Result<List<AssetStockGoodsDetail>> getByIds(List<String> ids);
	/**
	 * 查询库存物品明细
	*/
	@RequestMapping(AssetStockGoodsDetailServiceProxy.QUERY_LIST)
	Result<List<AssetStockGoodsDetail>> queryList(AssetStockGoodsDetailVO sample);

	/**
	 * 分页查询库存物品明细
	*/
	@RequestMapping(AssetStockGoodsDetailServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetStockGoodsDetail>> queryPagedList(AssetStockGoodsDetailVO sample);
