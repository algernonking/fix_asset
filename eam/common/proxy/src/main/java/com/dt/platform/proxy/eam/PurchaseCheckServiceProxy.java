...
;
	...
	*/
	...
	Result insert(PurchaseCheckVO purchaseCheckVO);
	...
	*/
	...
	Result update(PurchaseCheckVO purchaseCheckVO);

	/**
	 * 更新采购验收
	*/
	@RequestMapping(PurchaseCheckServiceProxy.SAVE)
	Result save(PurchaseCheckVO purchaseCheckVO);

	/**
	 * 获取采购验收
	*/
	@RequestMapping(PurchaseCheckServiceProxy.GET_BY_ID)
	Result<PurchaseCheck> getById(String id);

	/**
	 * 获取多个采购验收
	*/
	@RequestMapping(PurchaseCheckServiceProxy.GET_BY_IDS)
	Result<List<PurchaseCheck>> getByIds(List<String> ids);
	/**
	 * 查询采购验收
	*/
	@RequestMapping(PurchaseCheckServiceProxy.QUERY_LIST)
	Result<List<PurchaseCheck>> queryList(PurchaseCheckVO sample);

	/**
	 * 分页查询采购验收
	*/
	@RequestMapping(PurchaseCheckServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<PurchaseCheck>> queryPagedList(PurchaseCheckVO sample);
