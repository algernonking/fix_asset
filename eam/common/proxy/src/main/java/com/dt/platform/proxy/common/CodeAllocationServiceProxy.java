...
public interface CodeAllocationServiceProxy {
	...
	*/
	...
	Result insert(CodeAllocationVO codeAllocationVO);
	...
	*/
	...
	Result update(CodeAllocationVO codeAllocationVO);
	
	/**
	 * 更新编码分配
	*/
	@RequestMapping(CodeAllocationServiceProxy.SAVE)
	Result save(CodeAllocationVO codeAllocationVO);
	
	/**
	 * 获取编码分配
	*/
	@RequestMapping(CodeAllocationServiceProxy.GET_BY_ID)
	Result<CodeAllocation> getById(String id);

	/**
	 * 批量删除编码分配
	*/
	@RequestMapping(CodeAllocationServiceProxy.GET_BY_IDS)
	Result<List<CodeAllocation>> getByIds(List<String> ids);
	/**
	 * 查询编码分配
	*/
	@RequestMapping(CodeAllocationServiceProxy.QUERY_LIST)
	Result<List<CodeAllocation>> queryList(CodeAllocationVO sample);
	
	/**
	 * 分页查询编码分配
	*/
	@RequestMapping(CodeAllocationServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<CodeAllocation>> queryPagedList(CodeAllocationVO sample);
