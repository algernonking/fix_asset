...
;
	...
	*/
	...
	Result insert(PurchaseOrderDetailVO purchaseOrderDetailVO);
	...
	*/
	...
	Result update(PurchaseOrderDetailVO purchaseOrderDetailVO);

	/**
	 * 更新订单明细
	*/
	@RequestMapping(PurchaseOrderDetailServiceProxy.SAVE)
	Result save(PurchaseOrderDetailVO purchaseOrderDetailVO);

	/**
	 * 获取订单明细
	*/
	@RequestMapping(PurchaseOrderDetailServiceProxy.GET_BY_ID)
	Result<PurchaseOrderDetail> getById(String id);

	/**
	 * 获取多个订单明细
	*/
	@RequestMapping(PurchaseOrderDetailServiceProxy.GET_BY_IDS)
	Result<List<PurchaseOrderDetail>> getByIds(List<String> ids);
	/**
	 * 查询订单明细
	*/
	@RequestMapping(PurchaseOrderDetailServiceProxy.QUERY_LIST)
	Result<List<PurchaseOrderDetail>> queryList(PurchaseOrderDetailVO sample);

	/**
	 * 分页查询订单明细
	*/
	@RequestMapping(PurchaseOrderDetailServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<PurchaseOrderDetail>> queryPagedList(PurchaseOrderDetailVO sample);
