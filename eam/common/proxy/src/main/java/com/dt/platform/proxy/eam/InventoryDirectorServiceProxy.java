...
;
	...
	*/
	...
	Result insert(InventoryDirectorVO inventoryDirectorVO);
	...
	*/
	...
	Result update(InventoryDirectorVO inventoryDirectorVO);

	/**
	 * 更新盘点负责人
	*/
	@RequestMapping(InventoryDirectorServiceProxy.SAVE)
	Result save(InventoryDirectorVO inventoryDirectorVO);
	...
	*/
	...
	Result<List<InventoryDirector>> queryList(InventoryDirectorVO sample);

	/**
	 * 分页查询盘点负责人
	*/
	@RequestMapping(InventoryDirectorServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryDirector>> queryPagedList(InventoryDirectorVO sample);
