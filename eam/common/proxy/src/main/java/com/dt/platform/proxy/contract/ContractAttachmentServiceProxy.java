...
;
	...
	*/
	...
	Result insert(ContractAttachmentVO contractAttachmentVO);
	...
	*/
	...
	Result update(ContractAttachmentVO contractAttachmentVO);

	/**
	 * 更新合同附件
	*/
	@RequestMapping(ContractAttachmentServiceProxy.SAVE)
	Result save(ContractAttachmentVO contractAttachmentVO);

	/**
	 * 获取合同附件
	*/
	@RequestMapping(ContractAttachmentServiceProxy.GET_BY_ID)
	Result<ContractAttachment> getById(String id);

	/**
	 * 获取多个合同附件
	*/
	@RequestMapping(ContractAttachmentServiceProxy.GET_BY_IDS)
	Result<List<ContractAttachment>> getByIds(List<String> ids);
	/**
	 * 查询合同附件
	*/
	@RequestMapping(ContractAttachmentServiceProxy.QUERY_LIST)
	Result<List<ContractAttachment>> queryList(ContractAttachmentVO sample);

	/**
	 * 分页查询合同附件
	*/
	@RequestMapping(ContractAttachmentServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<ContractAttachment>> queryPagedList(ContractAttachmentVO sample);
