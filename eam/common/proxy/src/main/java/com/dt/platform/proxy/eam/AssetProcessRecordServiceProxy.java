...
;
	...
	*/
	...
	Result insert(AssetProcessRecordVO assetProcessRecordVO);
	...
	*/
	...
	Result update(AssetProcessRecordVO assetProcessRecordVO);

	/**
	 * 更新资产处理记录
	*/
	@RequestMapping(AssetProcessRecordServiceProxy.SAVE)
	Result save(AssetProcessRecordVO assetProcessRecordVO);

	/**
	 * 获取资产处理记录
	*/
	@RequestMapping(AssetProcessRecordServiceProxy.GET_BY_ID)
	Result<AssetProcessRecord> getById(String id);

	/**
	 * 批量删除资产处理记录
	*/
	@RequestMapping(AssetProcessRecordServiceProxy.GET_BY_IDS)
	Result<List<AssetProcessRecord>> getByIds(List<String> ids);
	/**
	 * 查询资产处理记录
	*/
	@RequestMapping(AssetProcessRecordServiceProxy.QUERY_LIST)
	Result<List<AssetProcessRecord>> queryList(AssetProcessRecordVO sample);

	/**
	 * 分页查询资产处理记录
	*/
	@RequestMapping(AssetProcessRecordServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetProcessRecord>> queryPagedList(AssetProcessRecordVO sample);
