...
;
	...
	*/
	...
	Result insert(InventoryCatalogVO inventoryCatalogVO);
	...
	*/
	...
	Result update(InventoryCatalogVO inventoryCatalogVO);

	/**
	 * 更新盘点分类
	*/
	@RequestMapping(InventoryCatalogServiceProxy.SAVE)
	Result save(InventoryCatalogVO inventoryCatalogVO);

	/**
	 * 获取盘点分类
	*/
	@RequestMapping(InventoryCatalogServiceProxy.GET_BY_ID)
	Result<InventoryCatalog> getById(String id);

	/**
	 * 获取多个盘点分类
	*/
	@RequestMapping(InventoryCatalogServiceProxy.GET_BY_IDS)
	Result<List<InventoryCatalog>> getByIds(List<String> ids);
	/**
	 * 查询盘点分类
	*/
	@RequestMapping(InventoryCatalogServiceProxy.QUERY_LIST)
	Result<List<InventoryCatalog>> queryList(InventoryCatalogVO sample);

	/**
	 * 分页查询盘点分类
	*/
	@RequestMapping(InventoryCatalogServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryCatalog>> queryPagedList(InventoryCatalogVO sample);
