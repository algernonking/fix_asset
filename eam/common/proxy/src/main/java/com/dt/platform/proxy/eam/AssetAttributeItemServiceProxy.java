...
public interface AssetAttributeItemServiceProxy {
	...
	*/
	...
	Result insert(AssetAttributeItemVO assetAttributeItemVO);
	...
	*/
	...
	Result update(AssetAttributeItemVO assetAttributeItemVO);
	
	/**
	 * 更新资产字段配置项
	*/
	@RequestMapping(AssetAttributeItemServiceProxy.SAVE)
	Result save(AssetAttributeItemVO assetAttributeItemVO);
	
	/**
	 * 获取资产字段配置项
	*/
	@RequestMapping(AssetAttributeItemServiceProxy.GET_BY_ID)
	Result<AssetAttributeItem> getById(String id);

	/**
	 * 批量删除资产字段配置项
	*/
	@RequestMapping(AssetAttributeItemServiceProxy.GET_BY_IDS)
	Result<List<AssetAttributeItem>> getByIds(List<String> ids);
	/**
	 * 查询资产字段配置项
	*/
	@RequestMapping(AssetAttributeItemServiceProxy.QUERY_LIST)
	Result<List<AssetAttributeItem>> queryList(AssetAttributeItemVO sample);
	...
	*/
	...
	Result<PagedList<AssetAttributeItem>> queryPagedList(AssetAttributeItemVO sample);
