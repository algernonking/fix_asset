...
;
	...
	*/
	...
	Result insert(AssetStockDeliverVO assetStockDeliverVO);
	...
	*/
	...
	Result update(AssetStockDeliverVO assetStockDeliverVO);

	/**
	 * 更新库存出库
	*/
	@RequestMapping(AssetStockDeliverServiceProxy.SAVE)
	Result save(AssetStockDeliverVO assetStockDeliverVO);

	/**
	 * 获取库存出库
	*/
	@RequestMapping(AssetStockDeliverServiceProxy.GET_BY_ID)
	Result<AssetStockDeliver> getById(String id);

	/**
	 * 获取多个库存出库
	*/
	@RequestMapping(AssetStockDeliverServiceProxy.GET_BY_IDS)
	Result<List<AssetStockDeliver>> getByIds(List<String> ids);
	/**
	 * 查询库存出库
	*/
	@RequestMapping(AssetStockDeliverServiceProxy.QUERY_LIST)
	Result<List<AssetStockDeliver>> queryList(AssetStockDeliverVO sample);

	/**
	 * 分页查询库存出库
	*/
	@RequestMapping(AssetStockDeliverServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetStockDeliver>> queryPagedList(AssetStockDeliverVO sample);
