...
;
	...
	*/
	...
	Result insert(BrandDemoVO brandDemoVO);
	...
	*/
	...
	Result update(BrandDemoVO brandDemoVO);

	/**
	 * 更新品牌
	*/
	@RequestMapping(BrandDemoServiceProxy.SAVE)
	Result save(BrandDemoVO brandDemoVO);

	/**
	 * 获取品牌
	*/
	@RequestMapping(BrandDemoServiceProxy.GET_BY_ID)
	Result<BrandDemo> getById(String id);

	/**
	 * 批量删除品牌
	*/
	@RequestMapping(BrandDemoServiceProxy.GET_BY_IDS)
	Result<List<BrandDemo>> getByIds(List<String> ids);
	/**
	 * 查询品牌
	*/
	@RequestMapping(BrandDemoServiceProxy.QUERY_LIST)
	Result<List<BrandDemo>> queryList(BrandDemoVO sample);

	/**
	 * 分页查询品牌
	*/
	@RequestMapping(BrandDemoServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<BrandDemo>> queryPagedList(BrandDemoVO sample);
