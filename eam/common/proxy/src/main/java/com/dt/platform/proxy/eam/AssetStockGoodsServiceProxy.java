...
;
	...
	*/
	...
	Result insert(AssetStockGoodsVO assetStockGoodsVO);
	...
	*/
	...
	Result update(AssetStockGoodsVO assetStockGoodsVO);

	/**
	 * 更新物品库存
	*/
	@RequestMapping(AssetStockGoodsServiceProxy.SAVE)
	Result save(AssetStockGoodsVO assetStockGoodsVO);

	/**
	 * 获取物品库存
	*/
	@RequestMapping(AssetStockGoodsServiceProxy.GET_BY_ID)
	Result<AssetStockGoods> getById(String id);

	/**
	 * 获取多个物品库存
	*/
	@RequestMapping(AssetStockGoodsServiceProxy.GET_BY_IDS)
	Result<List<AssetStockGoods>> getByIds(List<String> ids);
	/**
	 * 查询物品库存
	*/
	@RequestMapping(AssetStockGoodsServiceProxy.QUERY_LIST)
	Result<List<AssetStockGoods>> queryList(AssetStockGoodsVO sample);

	/**
	 * 分页查询物品库存
	*/
	@RequestMapping(AssetStockGoodsServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetStockGoods>> queryPagedList(AssetStockGoodsVO sample);
