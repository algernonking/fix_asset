...
public interface HostMidServiceProxy {
	...
	*/
	...
	Result insert(HostMidVO hostMidVO);
	...
	*/
	...
	Result update(HostMidVO hostMidVO);
	
	/**
	 * 更新中间件
	*/
	@RequestMapping(HostMidServiceProxy.SAVE)
	Result save(HostMidVO hostMidVO);
	
	/**
	 * 获取中间件
	*/
	@RequestMapping(HostMidServiceProxy.GET_BY_ID)
	Result<HostMid> getById(String id);

	/**
	 * 批量删除中间件
	*/
	@RequestMapping(HostMidServiceProxy.GET_BY_IDS)
	Result<List<HostMid>> getByIds(List<String> ids);
	/**
	 * 查询中间件
	*/
	@RequestMapping(HostMidServiceProxy.QUERY_LIST)
	Result<List<HostMid>> queryList(HostMidVO sample);
	
	/**
	 * 分页查询中间件
	*/
	@RequestMapping(HostMidServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<HostMid>> queryPagedList(HostMidVO sample);
