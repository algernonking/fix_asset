...
;
	...
	*/
	...
	Result insert(MonitorNodeVO monitorNodeVO);
	...
	*/
	...
	Result update(MonitorNodeVO monitorNodeVO);

	/**
	 * 更新节点
	*/
	@RequestMapping(MonitorNodeServiceProxy.SAVE)
	Result save(MonitorNodeVO monitorNodeVO);

	/**
	 * 获取节点
	*/
	@RequestMapping(MonitorNodeServiceProxy.GET_BY_ID)
	Result<MonitorNode> getById(String id);

	/**
	 * 获取多个节点
	*/
	@RequestMapping(MonitorNodeServiceProxy.GET_BY_IDS)
	Result<List<MonitorNode>> getByIds(List<String> ids);
	/**
	 * 查询节点
	*/
	@RequestMapping(MonitorNodeServiceProxy.QUERY_LIST)
	Result<List<MonitorNode>> queryList(MonitorNodeVO sample);

	/**
	 * 分页查询节点
	*/
	@RequestMapping(MonitorNodeServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNode>> queryPagedList(MonitorNodeVO sample);
