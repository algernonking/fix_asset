...
@FeignClient(value = EAMServiceNames.EAM, contextId = WarehouseServiceProxy.API_CONTEXT_PATH , configuration = FeignConfiguration.class)
public interface WarehouseServiceProxy {
	...
	*/
	 ...
	 * 控制器类名
	 * */
	public static final String CONTROLLER_CLASS_NAME="com.dt.eam.eam.controller.WarehouseController";
