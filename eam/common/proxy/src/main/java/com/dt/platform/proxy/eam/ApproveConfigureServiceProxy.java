...
;
	...
	*/
	...
	Result insert(ApproveConfigureVO approveConfigureVO);
	...
	*/
	...
	Result update(ApproveConfigureVO approveConfigureVO);

	/**
	 * 更新资产审批配置
	*/
	@RequestMapping(ApproveConfigureServiceProxy.SAVE)
	Result save(ApproveConfigureVO approveConfigureVO);

	/**
	 * 获取资产审批配置
	*/
	@RequestMapping(ApproveConfigureServiceProxy.GET_BY_ID)
	Result<ApproveConfigure> getById(String id);

	/**
	 * 批量删除资产审批配置
	*/
	@RequestMapping(ApproveConfigureServiceProxy.GET_BY_IDS)
	Result<List<ApproveConfigure>> getByIds(List<String> ids);
	/**
	 * 查询资产审批配置
	*/
	@RequestMapping(ApproveConfigureServiceProxy.QUERY_LIST)
	Result<List<ApproveConfigure>> queryList(ApproveConfigureVO sample);

	/**
	 * 分页查询资产审批配置
	*/
	@RequestMapping(ApproveConfigureServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<ApproveConfigure>> queryPagedList(ApproveConfigureVO sample);
