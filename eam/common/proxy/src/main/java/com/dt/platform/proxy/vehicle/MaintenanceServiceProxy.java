...
;
	...
	*/
	...
	Result insert(MaintenanceVO maintenanceVO);
	...
	*/
	...
	Result update(MaintenanceVO maintenanceVO);

	/**
	 * 更新车辆维修保养
	*/
	@RequestMapping(MaintenanceServiceProxy.SAVE)
	Result save(MaintenanceVO maintenanceVO);

	/**
	 * 获取车辆维修保养
	*/
	@RequestMapping(MaintenanceServiceProxy.GET_BY_ID)
	Result<Maintenance> getById(String id);

	/**
	 * 获取多个车辆维修保养
	*/
	@RequestMapping(MaintenanceServiceProxy.GET_BY_IDS)
	Result<List<Maintenance>> getByIds(List<String> ids);
	/**
	 * 查询车辆维修保养
	*/
	@RequestMapping(MaintenanceServiceProxy.QUERY_LIST)
	Result<List<Maintenance>> queryList(MaintenanceVO sample);

	/**
	 * 分页查询车辆维修保养
	*/
	@RequestMapping(MaintenanceServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<Maintenance>> queryPagedList(MaintenanceVO sample);
