...
@FeignClient(value = ServiceNames.DATACENTER, contextId = DcInfoServiceProxy.API_CONTEXT_PATH , configuration = FeignConfiguration.class)
public interface DcInfoServiceProxy {
	...
	*/
	 ...
	 * 控制器类名
	 * */
	public static final String CONTROLLER_CLASS_NAME="com.dt.platform.datacenter.controller.DcInfoController";
