...
;
	...
	*/
	...
	Result insert(MonitorNodeDbVO monitorNodeDbVO);
	...
	*/
	...
	Result update(MonitorNodeDbVO monitorNodeDbVO);

	/**
	 * 更新节点数据库
	*/
	@RequestMapping(MonitorNodeDbServiceProxy.SAVE)
	Result save(MonitorNodeDbVO monitorNodeDbVO);

	/**
	 * 获取节点数据库
	*/
	@RequestMapping(MonitorNodeDbServiceProxy.GET_BY_ID)
	Result<MonitorNodeDb> getById(String id);

	/**
	 * 获取多个节点数据库
	*/
	@RequestMapping(MonitorNodeDbServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeDb>> getByIds(List<String> ids);
	/**
	 * 查询节点数据库
	*/
	@RequestMapping(MonitorNodeDbServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeDb>> queryList(MonitorNodeDbVO sample);

	/**
	 * 分页查询节点数据库
	*/
	@RequestMapping(MonitorNodeDbServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeDb>> queryPagedList(MonitorNodeDbVO sample);
