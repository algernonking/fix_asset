...
@FeignClient(value = EAMServiceNames.EAM, contextId = SafetylevelServiceProxy.API_CONTEXT_PATH , configuration = FeignConfiguration.class)
public interface SafetylevelServiceProxy {
	...
	*/
	...
	Result insert(SafetylevelVO safetylevelVO);
	...
	*/
	...
	Result update(SafetylevelVO safetylevelVO);
	
	/**
	 * 更新风险等级
	*/
	@RequestMapping(SafetylevelServiceProxy.SAVE)
	Result save(SafetylevelVO safetylevelVO);
	
	/**
	 * 获取风险等级
	*/
	@RequestMapping(SafetylevelServiceProxy.GET_BY_ID)
	Result<Safetylevel> getById(String id);

	/**
	 * 批量删除风险等级
	*/
	@RequestMapping(SafetylevelServiceProxy.GET_BY_IDS)
	Result<List<Safetylevel>> getByIds(List<String> ids);
	/**
	 * 查询风险等级
	*/
	@RequestMapping(SafetylevelServiceProxy.QUERY_LIST)
	Result<List<Safetylevel>> queryList(SafetylevelVO sample);
	
	/**
	 * 分页查询风险等级
	*/
	@RequestMapping(SafetylevelServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<Safetylevel>> queryPagedList(SafetylevelVO sample);
	
	
	/**
	 * 控制器类名
	 * */
	public static final String CONTROLLER_CLASS_NAME="com.dt.eam.eam.controller.SafetylevelController";
