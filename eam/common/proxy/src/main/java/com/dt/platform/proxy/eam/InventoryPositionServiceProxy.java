...
;
	...
	*/
	...
	Result insert(InventoryPositionVO inventoryPositionVO);
	...
	*/
	...
	Result update(InventoryPositionVO inventoryPositionVO);

	/**
	 * 更新盘点位置
	*/
	@RequestMapping(InventoryPositionServiceProxy.SAVE)
	Result save(InventoryPositionVO inventoryPositionVO);

	/**
	 * 获取盘点位置
	*/
	@RequestMapping(InventoryPositionServiceProxy.GET_BY_ID)
	Result<InventoryPosition> getById(String id);

	/**
	 * 获取多个盘点位置
	*/
	@RequestMapping(InventoryPositionServiceProxy.GET_BY_IDS)
	Result<List<InventoryPosition>> getByIds(List<String> ids);
	/**
	 * 查询盘点位置
	*/
	@RequestMapping(InventoryPositionServiceProxy.QUERY_LIST)
	Result<List<InventoryPosition>> queryList(InventoryPositionVO sample);

	/**
	 * 分页查询盘点位置
	*/
	@RequestMapping(InventoryPositionServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryPosition>> queryPagedList(InventoryPositionVO sample);
