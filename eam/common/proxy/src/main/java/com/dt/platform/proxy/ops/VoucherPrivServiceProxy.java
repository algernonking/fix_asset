...
public interface VoucherPrivServiceProxy {
	...
	*/
	...
	Result insert(VoucherPrivVO voucherPrivVO);
	...
	*/
	...
	Result update(VoucherPrivVO voucherPrivVO);
	
	/**
	 * 更新凭证权限
	*/
	@RequestMapping(VoucherPrivServiceProxy.SAVE)
	Result save(VoucherPrivVO voucherPrivVO);
	
	/**
	 * 获取凭证权限
	*/
	@RequestMapping(VoucherPrivServiceProxy.GET_BY_ID)
	Result<VoucherPriv> getById(String id);

	/**
	 * 批量删除凭证权限
	*/
	@RequestMapping(VoucherPrivServiceProxy.GET_BY_IDS)
	Result<List<VoucherPriv>> getByIds(List<String> ids);
	/**
	 * 查询凭证权限
	*/
	...
	*/
	...
	Result<PagedList<VoucherPriv>> queryPagedList(VoucherPrivVO sample);
