...
;
	...
	*/
	...
	Result insert(MonitorWarnVO monitorWarnVO);
	...
	*/
	...
	Result update(MonitorWarnVO monitorWarnVO);

	/**
	 * 更新节点告警
	*/
	@RequestMapping(MonitorWarnServiceProxy.SAVE)
	Result save(MonitorWarnVO monitorWarnVO);

	/**
	 * 获取节点告警
	*/
	@RequestMapping(MonitorWarnServiceProxy.GET_BY_ID)
	Result<MonitorWarn> getById(String id);

	/**
	 * 获取多个节点告警
	*/
	@RequestMapping(MonitorWarnServiceProxy.GET_BY_IDS)
	Result<List<MonitorWarn>> getByIds(List<String> ids);
	/**
	 * 查询节点告警
	*/
	@RequestMapping(MonitorWarnServiceProxy.QUERY_LIST)
	Result<List<MonitorWarn>> queryList(MonitorWarnVO sample);

	/**
	 * 分页查询节点告警
	*/
	@RequestMapping(MonitorWarnServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorWarn>> queryPagedList(MonitorWarnVO sample);
