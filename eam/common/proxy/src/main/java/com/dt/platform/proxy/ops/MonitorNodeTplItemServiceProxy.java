...
;
	...
	*/
	...
	Result insert(MonitorNodeTplItemVO monitorNodeTplItemVO);
	...
	*/
	...
	Result update(MonitorNodeTplItemVO monitorNodeTplItemVO);

	/**
	 * 更新节点监控模版
	*/
	@RequestMapping(MonitorNodeTplItemServiceProxy.SAVE)
	Result save(MonitorNodeTplItemVO monitorNodeTplItemVO);

	/**
	 * 获取节点监控模版
	*/
	@RequestMapping(MonitorNodeTplItemServiceProxy.GET_BY_ID)
	Result<MonitorNodeTplItem> getById(String id);

	/**
	 * 获取多个节点监控模版
	*/
	@RequestMapping(MonitorNodeTplItemServiceProxy.GET_BY_IDS)
	Result<List<MonitorNodeTplItem>> getByIds(List<String> ids);
	/**
	 * 查询节点监控模版
	*/
	@RequestMapping(MonitorNodeTplItemServiceProxy.QUERY_LIST)
	Result<List<MonitorNodeTplItem>> queryList(MonitorNodeTplItemVO sample);

	/**
	 * 分页查询节点监控模版
	*/
	@RequestMapping(MonitorNodeTplItemServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorNodeTplItem>> queryPagedList(MonitorNodeTplItemVO sample);
