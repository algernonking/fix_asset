...
;
	...
	*/
	...
	Result insert(InventoryPlanVO inventoryPlanVO);
	...
	*/
	...
	Result update(InventoryPlanVO inventoryPlanVO);

	/**
	 * 更新盘点计划
	*/
	@RequestMapping(InventoryPlanServiceProxy.SAVE)
	Result save(InventoryPlanVO inventoryPlanVO);

	/**
	 * 获取盘点计划
	*/
	@RequestMapping(InventoryPlanServiceProxy.GET_BY_ID)
	Result<InventoryPlan> getById(String id);

	/**
	 * 获取多个盘点计划
	*/
	@RequestMapping(InventoryPlanServiceProxy.GET_BY_IDS)
	Result<List<InventoryPlan>> getByIds(List<String> ids);
	/**
	 * 查询盘点计划
	*/
	@RequestMapping(InventoryPlanServiceProxy.QUERY_LIST)
	Result<List<InventoryPlan>> queryList(InventoryPlanVO sample);

	/**
	 * 分页查询盘点计划
	*/
	@RequestMapping(InventoryPlanServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryPlan>> queryPagedList(InventoryPlanVO sample);
