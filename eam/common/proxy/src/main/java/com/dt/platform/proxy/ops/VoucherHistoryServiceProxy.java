...
public interface VoucherHistoryServiceProxy {
	...
	*/
	...
	Result insert(VoucherHistoryVO voucherHistoryVO);
	...
	*/
	...
	Result update(VoucherHistoryVO voucherHistoryVO);
	
	/**
	 * 更新凭证记录
	*/
	@RequestMapping(VoucherHistoryServiceProxy.SAVE)
	Result save(VoucherHistoryVO voucherHistoryVO);
	
	/**
	 * 获取凭证记录
	*/
	@RequestMapping(VoucherHistoryServiceProxy.GET_BY_ID)
	Result<VoucherHistory> getById(String id);

	/**
	 * 批量删除凭证记录
	*/
	@RequestMapping(VoucherHistoryServiceProxy.GET_BY_IDS)
	Result<List<VoucherHistory>> getByIds(List<String> ids);
	/**
	 * 查询凭证记录
	*/
	@RequestMapping(VoucherHistoryServiceProxy.QUERY_LIST)
	Result<List<VoucherHistory>> queryList(VoucherHistoryVO sample);
	
	/**
	 * 分页查询凭证记录
	*/
	@RequestMapping(VoucherHistoryServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<VoucherHistory>> queryPagedList(VoucherHistoryVO sample);
