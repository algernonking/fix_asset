...
;
	...
	*/
	...
	Result insert(AssetDataPermissionsCatalogVO assetDataPermissionsCatalogVO);
	...
	*/
	...
	Result update(AssetDataPermissionsCatalogVO assetDataPermissionsCatalogVO);

	/**
	 * 更新分类
	*/
	@RequestMapping(AssetDataPermissionsCatalogServiceProxy.SAVE)
	Result save(AssetDataPermissionsCatalogVO assetDataPermissionsCatalogVO);

	/**
	 * 获取分类
	*/
	@RequestMapping(AssetDataPermissionsCatalogServiceProxy.GET_BY_ID)
	Result<AssetDataPermissionsCatalog> getById(String id);

	/**
	 * 获取多个分类
	*/
	@RequestMapping(AssetDataPermissionsCatalogServiceProxy.GET_BY_IDS)
	Result<List<AssetDataPermissionsCatalog>> getByIds(List<String> ids);
	/**
	 * 查询分类
	*/
	@RequestMapping(AssetDataPermissionsCatalogServiceProxy.QUERY_LIST)
	Result<List<AssetDataPermissionsCatalog>> queryList(AssetDataPermissionsCatalogVO sample);

	/**
	 * 分页查询分类
	*/
	@RequestMapping(AssetDataPermissionsCatalogServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<AssetDataPermissionsCatalog>> queryPagedList(AssetDataPermissionsCatalogVO sample);
