...
;
	...
	*/
	...
	Result insert(MonitorTplGraphItemVO monitorTplGraphItemVO);
	...
	*/
	...
	Result update(MonitorTplGraphItemVO monitorTplGraphItemVO);

	/**
	 * 更新图形指标
	*/
	@RequestMapping(MonitorTplGraphItemServiceProxy.SAVE)
	Result save(MonitorTplGraphItemVO monitorTplGraphItemVO);

	/**
	 * 获取图形指标
	*/
	@RequestMapping(MonitorTplGraphItemServiceProxy.GET_BY_ID)
	Result<MonitorTplGraphItem> getById(String id);

	/**
	 * 获取多个图形指标
	*/
	@RequestMapping(MonitorTplGraphItemServiceProxy.GET_BY_IDS)
	Result<List<MonitorTplGraphItem>> getByIds(List<String> ids);
	/**
	 * 查询图形指标
	*/
	@RequestMapping(MonitorTplGraphItemServiceProxy.QUERY_LIST)
	Result<List<MonitorTplGraphItem>> queryList(MonitorTplGraphItemVO sample);

	/**
	 * 分页查询图形指标
	*/
	@RequestMapping(MonitorTplGraphItemServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorTplGraphItem>> queryPagedList(MonitorTplGraphItemVO sample);
