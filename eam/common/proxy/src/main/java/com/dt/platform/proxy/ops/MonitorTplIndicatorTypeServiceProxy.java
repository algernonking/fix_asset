...
;
	...
	*/
	...
	Result insert(MonitorTplIndicatorTypeVO monitorTplIndicatorTypeVO);
	...
	*/
	...
	Result update(MonitorTplIndicatorTypeVO monitorTplIndicatorTypeVO);

	/**
	 * 更新指标类型
	*/
	@RequestMapping(MonitorTplIndicatorTypeServiceProxy.SAVE)
	Result save(MonitorTplIndicatorTypeVO monitorTplIndicatorTypeVO);

	/**
	 * 获取指标类型
	*/
	@RequestMapping(MonitorTplIndicatorTypeServiceProxy.GET_BY_ID)
	Result<MonitorTplIndicatorType> getById(String id);

	/**
	 * 获取多个指标类型
	*/
	@RequestMapping(MonitorTplIndicatorTypeServiceProxy.GET_BY_IDS)
	Result<List<MonitorTplIndicatorType>> getByIds(List<String> ids);
	/**
	 * 查询指标类型
	*/
	@RequestMapping(MonitorTplIndicatorTypeServiceProxy.QUERY_LIST)
	Result<List<MonitorTplIndicatorType>> queryList(MonitorTplIndicatorTypeVO sample);

	/**
	 * 分页查询指标类型
	*/
	@RequestMapping(MonitorTplIndicatorTypeServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<MonitorTplIndicatorType>> queryPagedList(MonitorTplIndicatorTypeVO sample);
