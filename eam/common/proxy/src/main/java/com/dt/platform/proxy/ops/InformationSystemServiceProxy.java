...
public interface InformationSystemServiceProxy {
	...
	*/
	...
	Result insert(InformationSystemVO informationSystemVO);
	...
	*/
	...
	Result update(InformationSystemVO informationSystemVO);
	
	/**
	 * 更新信息系统
	*/
	@RequestMapping(InformationSystemServiceProxy.SAVE)
	Result save(InformationSystemVO informationSystemVO);
	
	/**
	 * 获取信息系统
	*/
	@RequestMapping(InformationSystemServiceProxy.GET_BY_ID)
	Result<InformationSystem> getById(String id);

	/**
	 * 批量删除信息系统
	*/
	@RequestMapping(InformationSystemServiceProxy.GET_BY_IDS)
	Result<List<InformationSystem>> getByIds(List<String> ids);
	/**
	 * 查询信息系统
	*/
	@RequestMapping(InformationSystemServiceProxy.QUERY_LIST)
	Result<List<InformationSystem>> queryList(InformationSystemVO sample);
	
	/**
	 * 分页查询信息系统
	*/
	@RequestMapping(InformationSystemServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InformationSystem>> queryPagedList(InformationSystemVO sample);
