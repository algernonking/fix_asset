...
;
	...
	*/
	...
	Result insert(SelectItemVO selectItemVO);
	...
	*/
	...
	Result update(SelectItemVO selectItemVO);

	/**
	 * 更新车辆数据
	*/
	@RequestMapping(SelectItemServiceProxy.SAVE)
	Result save(SelectItemVO selectItemVO);

	/**
	 * 获取车辆数据
	*/
	@RequestMapping(SelectItemServiceProxy.GET_BY_ID)
	Result<SelectItem> getById(String id);

	/**
	 * 获取多个车辆数据
	*/
	@RequestMapping(SelectItemServiceProxy.GET_BY_IDS)
	Result<List<SelectItem>> getByIds(List<String> ids);
	/**
	 * 查询车辆数据
	*/
	@RequestMapping(SelectItemServiceProxy.QUERY_LIST)
	Result<List<SelectItem>> queryList(SelectItemVO sample);

	/**
	 * 分页查询车辆数据
	*/
	@RequestMapping(SelectItemServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<SelectItem>> queryPagedList(SelectItemVO sample);
