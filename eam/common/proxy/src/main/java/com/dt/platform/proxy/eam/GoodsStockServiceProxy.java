...
;
	...
	*/
	...
	Result insert(GoodsStockVO goodsStockVO);
	...
	*/
	...
	Result update(GoodsStockVO goodsStockVO);

	/**
	 * 更新库存物品
	*/
	@RequestMapping(GoodsStockServiceProxy.SAVE)
	Result save(GoodsStockVO goodsStockVO);

	/**
	 * 获取库存物品
	*/
	@RequestMapping(GoodsStockServiceProxy.GET_BY_ID)
	Result<GoodsStock> getById(String id);

	/**
	 * 获取多个库存物品
	*/
	@RequestMapping(GoodsStockServiceProxy.GET_BY_IDS)
	Result<List<GoodsStock>> getByIds(List<String> ids);
	/**
	 * 查询库存物品
	*/
	@RequestMapping(GoodsStockServiceProxy.QUERY_LIST)
	Result<List<GoodsStock>> queryList(GoodsStockVO sample);

	/**
	 * 分页查询库存物品
	*/
	@RequestMapping(GoodsStockServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<GoodsStock>> queryPagedList(GoodsStockVO sample);
