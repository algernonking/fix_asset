 ...
 */
@FeignClient(value = ServiceNames.COMMON, contextId = TplFileServiceProxy.API_CONTEXT_PATH, configuration = FeignConfiguration.class)
public interface TplFileServiceProxy {
    ...
    /**
     * API 上下文路径 , sys-tpl-file
     */
    public static final String API_CONTEXT_PATH = "sys-tpl-file";
     ...
     * 返回模板文件流
     */
    @RequestMapping(TplFileServiceProxy.GET_TPL_FILE_STREAM_BY_CODE)
    InputStream getTplFileStreamByCode(@RequestParam(name = "code") String code);
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.common.controller.TplFileController";
