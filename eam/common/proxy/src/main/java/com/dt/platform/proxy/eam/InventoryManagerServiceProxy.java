...
;
	...
	*/
	...
	Result insert(InventoryManagerVO inventoryManagerVO);
	...
	*/
	...
	Result update(InventoryManagerVO inventoryManagerVO);

	/**
	 * 更新资产管理人
	*/
	@RequestMapping(InventoryManagerServiceProxy.SAVE)
	Result save(InventoryManagerVO inventoryManagerVO);

	/**
	 * 获取资产管理人
	*/
	@RequestMapping(InventoryManagerServiceProxy.GET_BY_ID)
	Result<InventoryManager> getById(String id);

	/**
	 * 批量删除资产管理人
	*/
	@RequestMapping(InventoryManagerServiceProxy.GET_BY_IDS)
	Result<List<InventoryManager>> getByIds(List<String> ids);
	/**
	 * 查询资产管理人
	*/
	@RequestMapping(InventoryManagerServiceProxy.QUERY_LIST)
	Result<List<InventoryManager>> queryList(InventoryManagerVO sample);

	/**
	 * 分页查询资产管理人
	*/
	@RequestMapping(InventoryManagerServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryManager>> queryPagedList(InventoryManagerVO sample);
