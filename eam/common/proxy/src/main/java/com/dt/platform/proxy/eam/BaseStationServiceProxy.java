...
public interface BaseStationServiceProxy {
    ...
    Result insert(@RequestParam(name = "baseStationVO") BaseStationVO baseStationVO);
    ...
    Result update(@RequestParam(name = "baseStationVO") BaseStationVO baseStationVO);

    /**
     * 更新rfid基站
     */
    @RequestMapping(BaseStationServiceProxy.SAVE)
    Result save(@RequestParam(name = "baseStationVO") BaseStationVO baseStationVO);

    /**
     * 获取rfid基站
     */
    @RequestMapping(BaseStationServiceProxy.GET_BY_ID)
    Result<BaseStation> getById(@RequestParam(name = "id") String id);

    /**
     * 批量删除rfid基站
     */
    @RequestMapping(BaseStationServiceProxy.GET_BY_IDS)
    Result<List<BaseStation>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询rfid基站
     */
    @RequestMapping(BaseStationServiceProxy.QUERY_LIST)
    Result<List<BaseStation>> queryList(@RequestParam(name = "sample") BaseStationVO sample);

    /**
     * 分页查询rfid基站
     */
    @RequestMapping(BaseStationServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<BaseStation>> queryPagedList(@RequestParam(name = "sample") BaseStationVO sample);
