...
public interface MonitorNodeMapServiceProxy {
    ...
    Result insert(@RequestParam(name = "monitorNodeMapVO") MonitorNodeMapVO monitorNodeMapVO);
    ...
    Result update(@RequestParam(name = "monitorNodeMapVO") MonitorNodeMapVO monitorNodeMapVO);

    /**
     * 更新节点映射
     */
    @RequestMapping(MonitorNodeMapServiceProxy.SAVE)
    Result save(@RequestParam(name = "monitorNodeMapVO") MonitorNodeMapVO monitorNodeMapVO);

    /**
     * 获取节点映射
     */
    @RequestMapping(MonitorNodeMapServiceProxy.GET_BY_ID)
    Result<MonitorNodeMap> getById(@RequestParam(name = "id") String id);

    /**
     * 获取多个节点映射
     */
    @RequestMapping(MonitorNodeMapServiceProxy.GET_BY_IDS)
    Result<List<MonitorNodeMap>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询节点映射
     */
    @RequestMapping(MonitorNodeMapServiceProxy.QUERY_LIST)
    Result<List<MonitorNodeMap>> queryList(@RequestParam(name = "sample") MonitorNodeMapVO sample);

    /**
     * 分页查询节点映射
     */
    @RequestMapping(MonitorNodeMapServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<MonitorNodeMap>> queryPagedList(@RequestParam(name = "sample") MonitorNodeMapVO sample);
