...
;
	...
	*/
	...
	Result insert(InventoryAssetVO inventoryAssetVO);
	...
	*/
	...
	Result update(InventoryAssetVO inventoryAssetVO);

	/**
	 * 更新盘点明细
	*/
	@RequestMapping(InventoryAssetServiceProxy.SAVE)
	Result save(InventoryAssetVO inventoryAssetVO);
	...
	*/
	...
	Result<List<InventoryAsset>> queryList(InventoryAssetVO sample);

	/**
	 * 分页查询盘点明细
	*/
	@RequestMapping(InventoryAssetServiceProxy.QUERY_PAGED_LIST)
	Result<PagedList<InventoryAsset>> queryPagedList(InventoryAssetVO sample);
