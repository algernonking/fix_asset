...
@ComponentScan(basePackages = {
		...
		PlatformMeta.FRAMEWORK_PACKAGE, PlatformMeta.SERVICE_EAM_PACKAGE, PlatformMeta.SERVICE_HRM_PACKAGE, PlatformMeta.DATACENTER_PACKAGE,
		PlatformMeta.OPS_PACKAGE,PlatformMeta.COMMON_PACKAGE
})
