...
#### 二次开发方式
- 1、所有需要二次开发的代码均已开放，确保不影响二次开发
- 2、私服如果无法下载,确保Maven版本是3.6，如果依旧无法下载，可以在本项目的二次开发目录的lib上找到，进行手动安装即可
- 3、SQL文件:(每日更新):http://121.43.103.102/upload/sql.tar.gz
- 4、运行环境要求:mysql版:5.7.X,Java版本:1.8
- 5、部署请参考Git目录文档目录下的《EAM安装部署维护手册.docx》
